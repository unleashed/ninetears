...
char *special_parse(char *buff)
{
    ...
    if (!strcmp(buff, "o") || !strcmp(buff, "w")) {
        return "oeste";
    }
    if (strcmp(buff, "s") == 0) {
        return "sur";
    ...
    if (!strcmp(buff, "no") || !strcmp(buff, "nw")) {
        return "noroeste";
    }
    if (strcmp(buff, "ne") == 0) {
        return "noreste";
    }
    if (!strcmp(buff, "so") || !strcmp(buff, "sw")) {
        return "sudoeste";
    }
    if (strcmp(buff, "se") == 0) {
        return "sudeste";
	...
	return "gritar FFIC MUDLIB - Copyright (c) 2001, 2002 Alex Unleashed <xelaco@yahoo.com>";
    return NULL;
}
#endif
