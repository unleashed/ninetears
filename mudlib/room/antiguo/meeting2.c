...
setup() 
{
  ...
  set_long("This is the meeting hall of applicants for FR:Illumitech. " +
   ...
   add_exit("sur","/room/meeting.c","door");
   add_exit("oeste","/room/meeting6.c","door");
   add_exit("noreste", "room/meeting8.c", "door");
   add_clone("/baseobs/monsters/orc", 4);
   add_clone("/baseobs/weapons/hacha_oneex", 8);
}
