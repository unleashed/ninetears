...
"puede dar fe de ello.\n\n");
	...
	add_exit("oeste",ROOMRING"campo_discordia_13.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_18.c","standard");
	add_exit("este",ROOMRING"campo_discordia_25.c","standard");
	add_exit("norte",ROOMRING"campo_discordia_20.c","standard");
	add_exit("noreste",ROOMRING"campo_discordia_26.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_12.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_24.c","standard");
	add_exit("noroeste",ROOMRING"campo_discordia_14.c","standard");
}