...
"puede dar fe de ello.\n\n");
	...
	add_exit("norte",ROOMRING"campo_discordia_7.c","standard");
	add_exit("noroeste",ROOMRING"campo_discordia_1.c","standard");
	add_exit("este",ROOMRING"campo_discordia_11.c","standard");
	add_exit("sur",ROOMRING"herreria_discordia.c","standard");
}