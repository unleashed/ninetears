...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_27.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_15.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_21.c","standard");
	add_exit("norte","/room/sala_portales.c","standard");
}