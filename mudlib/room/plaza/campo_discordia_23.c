...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_28.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_16.c","standard");
	add_exit("sur",ROOMRING"banco_discordia.c","standard");
}