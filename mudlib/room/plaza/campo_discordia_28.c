...
"puede dar fe de ello.\n\n");
	...
	add_exit("norte",ROOMRING"campo_discordia_29.c","standard");
	add_exit("noreste",ROOMRING"campo_discordia_33.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_23.c","standard");
	add_exit("sur",ROOMRING"tienda_discordia.c","standard");
}