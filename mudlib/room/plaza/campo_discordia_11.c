...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_16.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_6.c","standard");
	add_exit("sur",ROOMRING"taberna_turin.c","standard");
}