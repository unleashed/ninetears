...
"puede dar fe de ello.\n\n");
	...
	add_exit("sudeste",ROOMRING"campo_discordia_26.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_14.c","standard");
	add_exit("norte",ROOMRING"campo_discordia_22.c","standard");
}