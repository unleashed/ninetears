...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_23.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_11.c","standard");
	add_exit("norte",ROOMRING"campo_discordia_17.c","standard");
	add_exit("sur",ROOMRING"correo_discordia.c","door");
}