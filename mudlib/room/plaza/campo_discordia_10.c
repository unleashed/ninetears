...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_15.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_9.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_5.c","standard");
}