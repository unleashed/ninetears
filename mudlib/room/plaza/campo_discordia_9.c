...
"puede dar fe de ello.\n\n");
	...
	add_exit("oeste",ROOMRING"campo_discordia_5.c","standard");
	add_exit("norte",ROOMRING"campo_discordia_10.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_14.c","standard");
}