...
"puede dar fe de ello.\n\n");
	...
	add_exit("norte",ROOMRING"campo_discordia_36.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_34.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_30.c","standard");
	add_exit("este","/d/gremios/rooms/barbarocaos/barracks.c","door");
}