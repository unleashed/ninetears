...
"puede dar fe de ello.\n\n");
	...
	add_exit("oeste",ROOMRING"campo_discordia_27.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_31.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_37.c","standard");
}