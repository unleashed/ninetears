...
void setup() {
	...
	set_gp(1000);
      ...
      set_long("Laetitia, la guardiana del gremio de los clerigos de Gestur.\n\n"
		"Es una crack, yo de ti no me meteria con el.\n\n");
...
//               1, "@grin evilly $lname$",
	...
	set_guild("clerigo de gestur");
	set_guild_ob("/d/gremios/clerigos/gestur");
...
void event_enter(object enterer, string message)
{
	...
	if (enterer->query_guild_name() != "clerigo de gestur")
		return;
