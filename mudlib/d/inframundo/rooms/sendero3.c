...
void setup() {
	...
	set_long(query_short()+"\n Caminas por un largo sendero que atraviesa todo el Inframundo. El camino es de hielo negro, como todo lo demas en este lugar, y a los lados todo esta lleno de llamas azules y estalactitas. El camino conduce a una caverna.\n\n");
   	...
   	add_exit("oeste",ROOMS+"sendero2","plain");
   	add_exit("este",ROOMS+"caverna1","plain");
