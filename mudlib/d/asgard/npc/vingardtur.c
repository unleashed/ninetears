...
void setup()
{
  ...
  set_long("Vingardtur, Maestro de los Caballeros de JaDe.\n"
  	   ...
  	   "como si un millar de gélidos alfileres se clavaran en tu piel, y a pesar de " 
  	   "tus esfuerzos en un primer instante sólo consigues distinguir una figura sombría " 
  	   "y dos ojos de un verde tan profundo que parecen estar leyendo tus mas íntimos " 
	   ...
	   "Una permanente aura ancestral de maldad y fiel devoción a su Diosa le rodea.\n"
  ...
  set_join_fight_mess("Vingardtur exclama: "+
        "Tu alma pasará a pertenecerme!\n");
  add_property("magical",75);
  load_a_chat(10,
  ({
     1, "'Pagarás con tu sangre semejante traición!",
     1, "'Otra alma para La Dama Oscura!",
    
  }));
  load_chat(10,
  ({
     1, ":dice solemnemente: Extendere mi ejército de muerte por todo el reino, es la voluntad de JaDe y así se hará.",
     1, ":te mira fríamente, clavando sus verdes ojos en ti.",
     1, ":acaricia el filo de su espada y en su rostro se dibuja una tétrica sonrisa.",
     1, ":dice: Es nuestro deber obedecer a La Dama Oscura, jamás oses desacatar una orden.",
     1, ":dice seriamente: Si provocas mi ira o la de mi Señora no vivirás para contarlo.",
     1, ":dice fríamente: No oses traicionar a La Dama Oscura.",
