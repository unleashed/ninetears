...
void setup ()
{
set_short ("Calabozo de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Oeste");
set_long ("Calabozo de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Oeste\n\n"
	...
	set_light (60);
        set_exit_color("blue");
	add_exit("este","/d/asgard/room/hall/cala.c","corridor");
