...
void setup ()
{
set_short ("Calabozo de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Norte");
set_long ("Calabozo de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Norte\n\n"
	...
	set_light (60);
        set_exit_color("blue");
	add_exit("sur","/d/asgard/room/hall/cala.c","corridor");
