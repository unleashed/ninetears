...
void setup ()
{
set_short ("Biblioteca de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Norte");
set_long ("Biblioteca de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Norte\n\n"
	...
	set_light (60);
        set_exit_color("blue");
	add_exit("sur","/d/asgard/room/hall/biblio1.c","corridor");
