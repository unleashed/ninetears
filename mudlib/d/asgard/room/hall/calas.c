...
void setup ()
{
set_short ("Calabozo de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Sur");
set_long ("Calabozo de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Ala Sur\n\n"
	...
	set_light (60);
        set_exit_color("blue");
	add_exit("norte","/d/asgard/room/hall/cala.c","corridor");
