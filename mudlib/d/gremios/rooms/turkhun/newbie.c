...
void setup () {
	::setup();
  	set_saqueable(0);
    	set_short("%^RED%^%^BOLD%^Gremio de los Guerreros Turkhun: %^WHITE%^%^BOLD%^Baul Newbie%^RESET%^");
  	set_long(query_short()+"\n\n    Te encuentras en una pequenya sala sin muebles ni"
  					" ningun tipo de decoracion, excepto un gran baul"
  					" al final. Este baul esta destinado a los Guerreros Turkhun"
  					" mas novatos.\n\n");
  	...
  	add_exit("sudeste",GUILD_TURKHUN+"tablon","door");
}