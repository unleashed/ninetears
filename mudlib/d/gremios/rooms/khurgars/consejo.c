...
void setup() {
	set_short("%^RED%^%^BOLD%^Gremio de los Khurgars: %^WHITE%^%^BOLD%^Sala de Asambleas%^RESET%^");
	set_long(query_short()+"\n\n    En esta espaciosa sala se reune el Consejo de Khurgars "
	...
	add_exit("fuera",GUILD_KHURGARS+"guildroom","door");
}
