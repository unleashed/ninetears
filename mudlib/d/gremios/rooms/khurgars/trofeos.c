...
void setup() {
	set_short("%^RED%^%^BOLD%^Gremio de los Khurgars: %^WHITE%^%^BOLD%^Sala de Trofeos%^RESET%^");
	set_long(query_short()+"\n\n    Te encuentras en la sala mas profunda de las "
					"cavernas del gremio. Aqui los Khurgars "
	...
	add_exit("arriba",GUILD_KHURGARS+"herreria","corridor");
}
