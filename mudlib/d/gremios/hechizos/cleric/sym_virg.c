...
#define VIRGA_SYMBOL "/d/gremios/hechizos/items/virga_symbol.c"
  ...
  switch(this_object()->query_level())
  {
    case 14..17:
      add_attack_spell(40, "burning hands",
                      ({"/d/gremios/hechizos/wizard/burnhand.c", 
			"cast_spell",0}));
    break;
    case 18..21:
      add_attack_spell(40, "shocking grasp",
		      ({"/d/gremios/hechizos/wizard/shock_grasp.c", 
			"cast_spell",0}));
    break;
    case 22..25:
      add_attack_spell(40, "major missle",
		      ({"/d/gremios/hechizos/wizard/maj_missle.c", 
		        "cast_spell",0}));
    break;
    case 26..30:
      add_attack_spell(40, "flame arrow",
		      ({"/d/gremios/hechizos/wizard/flame_arrow.c",
			"cast_spell",0}));
    break;
    case 31..35:
      add_attack_spell(40, "lightning bolt",
		      ({"/d/gremios/hechizos/wizard/lightning.c",
			"cast_spell",0}));
    break;
    case 36..99:
      add_attack_spell(40, "fireball",
		      ({"/d/gremios/hechizos/wizard/fireball.c",
			"cast_spell",1}));
    break;
  }
}
