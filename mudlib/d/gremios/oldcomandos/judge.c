...
string query_judge_mess(int flag)
{
  switch(flag)
  {
    ...
    case 2 : return "Malo";
    case 3 : return "Pobre";
    case 4 : return "Inferior a la media";
    case 5 : return "Mediano";
    case 6 : return "Superior a la media";
    case 7 : return "Bueno";
    case 8 : return "Grande";
    case 9 : return "Maravilloso";
    case 10 : return "Increible";
    case 11 : return "Pa fliparlo";
...
int judge(string str, object who)
{
  ...
  if(!str)
  {
    tell_object(me,"Syntaxis: judgar <objeto>\n");
    return 1;
  }
...
str="0";
  ...
  if(!sizeof(ob))
  {
    tell_object(me,"No llevas nada llamado "+str+".\n");
    return 1;
  }
  ...
  for(i=0;i<sizeof(ob);i++)
  {
    if(ob[i]->query_weapon())
      ...
      tell_object(me,ob[i]->query_short()+" parece bastante inutil para ti.\n");
  }
