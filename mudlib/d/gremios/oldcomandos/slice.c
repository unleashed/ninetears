...
//tell_object(me,"Hits "+hits+" Rate "+rate+" Extra "+extrahits+"\n");
...
*/
  ...
  tell_room(environment(me), me->query_cap_name()+
	...
	me->dest_hide_shadow();
me->attack_ob(victim);
  //victim->attack_by(me); // si se pone solo esto no entramos nosotros
  			// en peleas hasta que nos ataka el
  			// por eso entablamos peleas entre los 2
  			// hay q poner un me->attack_ob(victim)
  			// en el primer round no entran los pinyos de peleas
