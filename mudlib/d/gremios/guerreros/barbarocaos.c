...
void setup() {
    	...
    	set_long("Este es el gremio de los Barbaros del Caos, guerreros fanaticos y salvajes donde los haya, que se dedican "
	    "a extender el mal por Driade en nombre de su diosa Jade, la senyora del Mal. Aunque no pueden utilizar armaduras"
	    " pesadas, lo compensan gracias a sus grandes dotes para el combate y son capaces de fabricar su propio equipo.\n");
    	reset_get();
