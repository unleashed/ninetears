...
void setup() 
  {
  set_name("battle rager enano");
  set_short("Battle Rager Enano");
  set_long(
...
string query_title(object ob) {
	if (ob->query_gender() == 1) {
		switch(ob->query_level()) {
			case 0..10:
				return "Aprendiz de Khalim";
			case 11..15:
				return "Discipulo de Khalim";
			case 16..20:
				return "Soldado de Kheleb-Dum";
			case 21..25:
				return "Patrullero de Kheleb-Dum";
			case 26..30:
				return "Protector de Kheleb-Dum";
			case 31..35:
				return "Senyor de la Ira";
			case 36..40:
				return "Temido Guerrero de la Ira";
			case 41..45:
				return "Gran Guerrero del Orden";
			case 46..50:
				return "Sangriento Destripador de Duergars";
			case 51..55:
				return "%^BOLD%^General de los Ejercitos %^RESET%^de %^BOLD%^%^GREEN%^Kheleb-Dum%^RESET%^";
			case 56..60:
				return "%^BOLD%^Caudillo de los Ejercitos %^RESET%^de %^BOLD%^%^GREEN%^Kheleb-Dum%^RESET%^";
			case 61..1000:
				return "%^BOLD%^%^CYAN%^Primer Enemigo %^RESET%^de %^BOLD%^%^BLUE%^Bendorf%^RESET%^";
			default:
				return "Battle Rager Enano Erroneo";
		}
	}
	else {
		switch(ob->query_level()) {
			case 0..10:
				return "Aprendiz de Khalim";
			case 11..15:
				return "Seguidora de Khalim";
			case 16..20:
				return "Soldado de Kheleb-Dum";
			case 21..25:
				return "Patrullera de Kheleb-Dum";
			case 26..30:
				return "Protectora de Kheleb-Dum";
			case 31..35:
				return "Lady de la Ira";
			case 36..40:
				return "Temida Guerrera de la Ira";
			case 41..45:
				return "Gran Guerrera del Orden";
			case 46..50:
				return "Sangrienta Destripadora de Duergars";
			case 51..55:
				return "%^BOLD%^General de los Ejercitos %^RESET%^de %^BOLD%^%^GREEN%^Kheleb-Dum%^RESET%^";
			case 56..60:
				return "%^BOLD%^Caudillo de los Ejercitos %^RESET%^de %^BOLD%^%^GREEN%^Kheleb-Dum%^RESET%^";
			case 61..1000:
				return "%^BOLD%^%^CYAN%^Primer Enemigo %^RESET%^de %^BOLD%^%^BLUE%^Bendorf%^RESET%^";
			default:
				return "Battle Rager Enana Erronea";
		}
	}
}
