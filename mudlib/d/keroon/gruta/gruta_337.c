...
add_exit("oeste",GRUTA+"gruta_336.c","corridor");
add_exit("noroeste",GRUTA+"gruta_327.c","corridor");
add_exit("norte",GRUTA+"gruta_328.c","corridor");
add_exit("noreste",GRUTA+"gruta_329.c","corridor");
}
