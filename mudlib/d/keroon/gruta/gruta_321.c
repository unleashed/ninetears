...
add_exit("noroeste",GRUTA+"gruta_302.c","corridor");
add_exit("norte",GRUTA+"gruta_303.c","corridor");
add_exit("este",GRUTA+"gruta_322.c","corridor");
add_exit("sur",GRUTA+"gruta_332.c","corridor");
}
