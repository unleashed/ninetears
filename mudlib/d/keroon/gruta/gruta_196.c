...
add_exit("norte",GRUTA+"gruta_175.c","corridor");
add_exit("este",GRUTA+"gruta_197.c","corridor");
add_exit("sudeste",GRUTA+"gruta_211.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_210.c","corridor");
}
