...
add_exit("norte",GRUTA+"gruta_211.c","corridor");
add_exit("sudeste",GRUTA+"gruta_245.c","corridor");
add_exit("sur",GRUTA+"gruta_244.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_243.c","corridor");
}
