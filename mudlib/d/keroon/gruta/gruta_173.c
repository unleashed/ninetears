...
add_exit("oeste",GRUTA+"gruta_172.c","corridor");
add_exit("noreste",GRUTA+"gruta_158.c","corridor");
add_exit("sudeste",GRUTA+"gruta_195.c","corridor");
add_exit("sur",GRUTA+"gruta_194.c","corridor");
}
