...
add_exit("oeste",GRUTA+"gruta_111.c","corridor");
add_exit("norte",GRUTA+"gruta_100.c","corridor");
add_exit("este",GRUTA+"gruta_113.c","corridor");
add_exit("sudeste",GRUTA+"gruta_127.c","corridor");
}
