...
add_exit("noroeste",GRUTA+"gruta_55.c","corridor");
add_exit("este",GRUTA+"gruta_69.c","corridor");
add_exit("sudeste",GRUTA+"gruta_81.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_80.c","corridor");
}
