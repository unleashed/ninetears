...
add_exit("norte",GRUTA+"gruta_88.c","corridor");
add_exit("noreste",GRUTA+"gruta_89.c","corridor");
add_exit("este",GRUTA+"gruta_102.c","corridor");
add_exit("sudeste",GRUTA+"gruta_114.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_113.c","corridor");
}
