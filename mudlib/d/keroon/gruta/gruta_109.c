...
add_exit("noreste",GRUTA+"gruta_99.c","corridor");
add_exit("este",GRUTA+"gruta_110.c","corridor");
add_exit("sudeste",GRUTA+"gruta_126.c","corridor");
add_exit("sudoeste",ENTRADA+"ent14.c","corridor");
}
