...
add_exit("oeste",GRUTA+"gruta_91.c","corridor");
add_exit("noroeste",GRUTA+"gruta_81.c","corridor");
add_exit("noreste",GRUTA+"gruta_82.c","corridor");
add_exit("sudeste",GRUTA+"gruta_104.c","corridor");
}
