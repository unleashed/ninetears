...
add_exit("noroeste",GRUTA+"gruta_272.c","corridor");
add_exit("norte",GRUTA+"gruta_273.c","corridor");
add_exit("sur",GRUTA+"gruta_300.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_299.c","corridor");
}
