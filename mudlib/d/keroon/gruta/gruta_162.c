...
add_exit("oeste",GRUTA+"gruta_161.c","corridor");
add_exit("noroeste",GRUTA+"gruta_146.c","corridor");
add_exit("norte",GRUTA+"gruta_147.c","corridor");
add_exit("noreste",GRUTA+"gruta_148.c","corridor");
add_exit("este",GRUTA+"gruta_163.c","corridor");
add_exit("sudeste",GRUTA+"gruta_182.c","corridor");
add_exit("sur",GRUTA+"gruta_181.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_180.c","corridor");
}
