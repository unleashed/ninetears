...
add_exit("noroeste",GRUTA+"gruta_306.c","corridor");
add_exit("norte",GRUTA+"gruta_307.c","corridor");
add_exit("este",GRUTA+"gruta_324.c","corridor");
add_exit("sur",GRUTA+"gruta_333.c","corridor");
}
