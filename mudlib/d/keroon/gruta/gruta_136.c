...
add_exit("oeste",GRUTA+"gruta_135.c","corridor");
add_exit("noreste",GRUTA+"gruta_121.c","corridor");
add_exit("sur",GRUTA+"gruta_155.c","corridor");
add_exit("sudoeste",GRUTA+"gruta_154.c","corridor");
}
