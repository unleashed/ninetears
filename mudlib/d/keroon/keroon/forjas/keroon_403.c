...
add_exit("oeste",KEROONPOBRE+"keroon_402.c","standard");
// add_exit("puertas",KEROONPOBRE+"keroon_57.c","standard");
add_exit("este",FORJAS+"keroon_404.c","standard");
add_exit("sur",FORJAS+"keroon_428.c","standard");
}
