...
add_exit("oeste",FORJAS+"keroon_404.c","standard");
add_exit("norte",FORJAS+"keroon_385.c","standard");
add_exit("este",FORJAS+"keroon_406.c","standard");
add_exit("sur",FORJAS+"keroon_430.c","standard");
}
