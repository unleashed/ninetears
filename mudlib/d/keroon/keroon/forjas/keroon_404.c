...
add_exit("oeste",FORJAS+"keroon_403.c","standard");
add_exit("norte",FORJAS+"keroon_384.c","standard");
add_exit("este",FORJAS+"keroon_405.c","standard");
add_exit("sur",FORJAS+"keroon_429.c","standard");
}
