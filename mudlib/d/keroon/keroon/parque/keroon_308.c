...
add_exit("este",PARQUE+"keroon_309.c","standard");
add_exit("sudeste",PARQUE+"keroon_329.c","standard");
add_exit("sur",PARQUE+"keroon_328.c","standard");
add_exit("sudoeste",PARQUE+"keroon_327.c","standard");
}
