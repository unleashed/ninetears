...
add_exit("oeste" ,PALACIO+"palacio_117.c","standard");
add_exit("este" ,PALACIO+"palacio_119.c","standard");
add_exit("sur" ,PALACIO+"palacio_128.c","standard");
add_exit("norte" ,PALACIO+"palacio_111.c","standard");
