...
add_exit("norte" ,PALACIO+"palacio_066.c","standard");
add_exit("sur",PALACIO+"palacio_079.c","standard");
add_exit("este",PALACIO+"palacio_073.c","standard");
add_exit("oeste",PALACIO+"palacio_071.c","standard");
