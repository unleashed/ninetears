...
add_exit("norte" ,PALACIO+"palacio_122.c","standard");
add_exit("sur" ,PALACIO+"palacio_143.c","standard");
add_exit("este" ,PALACIO+"palacio_133.c","standard");
add_exit("oeste" ,PALACIO+"palacio_131.c","standard");
