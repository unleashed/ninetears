...
add_exit("oeste" ,PALACIO+"palacio_119.c","standard");
add_exit("este" ,PALACIO+"palacio_121.c","standard");
add_exit("sur" ,PALACIO+"palacio_130.c","standard");
add_exit("norte" ,PALACIO+"palacio_112.c","standard");
