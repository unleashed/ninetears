...
add_exit("norte" ,PALACIO+"palacio_114.c","standard");
add_exit("sur" ,PALACIO+"palacio_135.c","standard");
add_exit("este" ,PALACIO+"palacio_125.c","standard");
add_exit("arriba",PALACIO+"palacio_021.c","standard");
