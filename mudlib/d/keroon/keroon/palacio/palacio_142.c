...
add_exit("norte" ,PALACIO+"palacio_131.c","standard");
add_exit("este" ,PALACIO+"palacio_143.c","standard");
add_exit("oeste" ,PALACIO+"palacio_141.c","standard");
add_exit("sur" ,PALACIO+"palacio_147.c","standard");
