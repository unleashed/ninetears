...
add_exit("norte",PALACIO+"palacio_022.c","standard");
add_exit("oeste",PALACIO+"palacio_024.c","standard");
add_exit("este",PALACIO+"palacio_026.c","standard");
add_exit("sur",PALACIO+"palacio_030.c","standard");
}