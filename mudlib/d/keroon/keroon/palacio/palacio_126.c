...
add_exit("norte" ,PALACIO+"palacio_116.c","standard");
add_exit("sur" ,PALACIO+"palacio_137.c","standard");
add_exit("este" ,PALACIO+"palacio_127.c","standard");
add_exit("oeste" ,PALACIO+"palacio_125.c","standard");
