...
add_exit("norte" ,PALACIO+"palacio_128.c","standard");
add_exit("este" ,PALACIO+"palacio_140.c","standard");
add_exit("oeste" ,PALACIO+"palacio_138.c","standard");
add_exit("sur" ,PALACIO+"palacio_145.c","standard");
