...
add_exit("norte",PALACIO+"palacio_091.c","standard");
add_exit("sur",PALACIO+"palacio_101.c","standard");
add_exit("este" ,PALACIO+"palacio_097.c","standard");
add_exit("oeste",PALACIO+"palacio_095.c","standard");
