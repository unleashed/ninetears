...
add_exit("norte" ,PALACIO+"palacio_121.c","standard");
add_exit("sur" ,PALACIO+"palacio_142.c","standard");
add_exit("este" ,PALACIO+"palacio_132.c","standard");
add_exit("oeste" ,PALACIO+"palacio_130.c","standard");
