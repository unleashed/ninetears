...
add_exit("oeste",PALACIO+"palacio_014.c","standard");
add_exit("este",PALACIO+"palacio_016.c","standard");
add_exit("sur",PALACIO+"palacio_018.c","standard");
add_exit("norte",PALACIO+"palacio_010.c","standard");
}
