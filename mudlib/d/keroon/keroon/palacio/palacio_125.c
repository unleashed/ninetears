...
add_exit("norte" ,PALACIO+"palacio_115.c","standard");
add_exit("sur" ,PALACIO+"palacio_136.c","standard");
add_exit("este" ,PALACIO+"palacio_126.c","standard");
add_exit("oeste" ,PALACIO+"palacio_124.c","standard");
