...
add_exit("norte" ,PALACIO+"palacio_118.c","standard");
add_exit("sur" ,PALACIO+"palacio_139.c","standard");
add_exit("este" ,PALACIO+"palacio_129.c","standard");
add_exit("oeste" ,PALACIO+"palacio_127.c","standard");

add_clone(NPCSPALACIO+"guardia_palacio.c",2);
}
