...
add_exit("norte" ,PALACIO+"palacio_043.c","standard");
add_exit("sur",PALACIO+"palacio_056.c","standard");
add_exit("este",PALACIO+"palacio_051.c","standard");
add_exit("oeste",PALACIO+"palacio_049.c","standard");
}