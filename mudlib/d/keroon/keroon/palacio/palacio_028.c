...
add_exit("norte",PALACIO+"palacio_023.c","standard");
add_exit("oeste",PALACIO+"palacio_027.c","standard");
add_exit("este",PALACIO+"palacio_029.c","standard");
add_exit("sur",PALACIO+"palacio_031.c","standard");
}