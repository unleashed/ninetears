...
add_exit("oeste" ,PALACIO+"palacio_120.c","standard");
add_exit("este" ,PALACIO+"palacio_122.c","standard");
add_exit("sur" ,PALACIO+"palacio_131.c","standard");
add_exit("norte" ,PALACIO+"palacio_113.c","standard");
