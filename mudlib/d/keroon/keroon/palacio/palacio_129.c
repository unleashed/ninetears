...
add_exit("norte" ,PALACIO+"palacio_119.c","standard");
add_exit("sur" ,PALACIO+"palacio_140.c","standard");
add_exit("este" ,PALACIO+"palacio_130.c","standard");
add_exit("oeste" ,PALACIO+"palacio_128.c","standard");
