...
add_exit("norte" ,PALACIO+"palacio_117.c","standard");
add_exit("sur" ,PALACIO+"palacio_138.c","standard");
add_exit("este" ,PALACIO+"palacio_128.c","standard");
add_exit("oeste" ,PALACIO+"palacio_126.c","standard");
