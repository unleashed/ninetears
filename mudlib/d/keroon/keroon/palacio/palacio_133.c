...
add_exit("norte" ,PALACIO+"palacio_123.c","standard");
add_exit("sur" ,PALACIO+"palacio_144.c","standard");
add_exit("este" ,PALACIO+"palacio_134.c","standard");
add_exit("oeste" ,PALACIO+"palacio_132.c","standard");
