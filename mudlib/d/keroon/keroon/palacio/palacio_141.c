...
add_exit("norte" ,PALACIO+"palacio_130.c","standard");
add_exit("este" ,PALACIO+"palacio_142.c","standard");
add_exit("oeste" ,PALACIO+"palacio_140.c","standard");
add_exit("sur" ,PALACIO+"palacio_146.c","standard");
