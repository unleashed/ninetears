...
add_exit("oeste",PALACIO+"palacio_011.c","standard");
add_exit("este",PALACIO+"palacio_013.c","standard");
add_exit("norte",PALACIO+"palacio_009.c","standard");
add_exit("sur",PALACIO+"palacio_017.c","standard");
}
