...
void setup()
{
  set_name("Sargento de Keroon");
  add_alias("guardia");
  add_alias("guardian");
  add_alias("sargento");
  set_short("Sargento de Keroon");
  ...
  set_cha(100);
set_level(30+random(5));/*ponedlo depues de los stats..pa ke rule bien si no calcula la vida antes del nivel y puede salir con muy poca.*/

   set_ciudadania("Keroon");

  set_main_plural("sargentos");
