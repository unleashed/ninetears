...
void setup() {
   ...
   add_clone(NPCSKEROONPOBRE+"guardian_keroon_pobre.c",random(2)); 

   add_exit("oeste",KEROONPOBRE+"keroon_110.c","standard");
   add_exit("escaleras",KEROONRICO+"keroon_112.c","standard");
