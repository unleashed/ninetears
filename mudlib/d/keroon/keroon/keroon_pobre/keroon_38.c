...
add_exit("oeste",KEROONPOBRE+"keroon_37.c","standard");
add_exit("dentro",KEROONPOBRE+"taberna_pollo_cojo.c","standard");
add_exit("este",KEROONPOBRE+"keroon_39.c","standard");
}
