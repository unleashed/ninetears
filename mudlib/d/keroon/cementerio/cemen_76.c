...
add_exit("oeste",CEMENTERIO+"cemen_75.c","standard");
add_exit("norte",CEMENTERIO+"cemen_63.c","standard");
add_exit("este",CEMENTERIO+"cemen_77.c","standard");
add_exit("sur",CEMENTERIO+"cemen_88.c","standard");
}
