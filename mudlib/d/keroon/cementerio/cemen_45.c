...
add_exit("oeste",CEMENTERIO+"cemen_44.c","standard");
add_exit("norte",CEMENTERIO+"cemen_30.c","standard");
add_exit("este",CEMENTERIO+"cemen_46.c","standard");
add_exit("sur",CEMENTERIO+"cemen_55.c","standard");
}
