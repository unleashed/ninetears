...
add_exit("oeste",CEMENTERIO+"cemen_103.c","standard");
add_exit("norte",CEMENTERIO+"cemen_95.c","standard");
add_exit("este",CEMENTERIO+"cemen_105.c","standard");
add_exit("sur",CEMENTERIO+"cemen_120.c","standard");
}
