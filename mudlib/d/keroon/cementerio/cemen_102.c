...
void setup() {
   ...
   set_long("\n%^BOLD%^Cementerio abandonado%^RESET%^.\n\n""Te encuentras en un cementerio abandonado, un escalofrio te recorre toda la columna vertebral, por todos lados ves lapidas rotas y tumbas abiertas, despojadas de cualquier resto que pudieran contener. No cabe la menor duda de que el lugar se halla maldito por alguna fuerza desconocida""\n\n");
...
add_exit("oeste",CEMENTERIO+"cemen_101.c","standard");
add_exit("este",CEMENTERIO+"cemen_103.c","standard");
}
