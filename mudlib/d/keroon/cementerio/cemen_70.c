...
add_exit("oeste",CEMENTERIO+"cemen_69.c","standard");
add_exit("norte",CEMENTERIO+"cemen_60.c","standard");
add_exit("este",CEMENTERIO+"cemen_71.c","standard");
add_exit("sur",CEMENTERIO+"cemen_86.c","standard");
}
