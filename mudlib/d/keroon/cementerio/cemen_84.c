...
add_exit("oeste",CEMENTERIO+"cemen_83.c","standard");
add_exit("norte",CEMENTERIO+"cemen_66.c","standard");
add_exit("sur",CEMENTERIO+"cemen_92.c","standard");
add_exit("puertas",CEMENTERIO+"cemen_93.c","standard");
}
