...
add_exit("oeste",CEMENTERIO+"cemen_78.c","standard");
add_exit("norte",CEMENTERIO+"cemen_64.c","standard");
add_exit("este",CEMENTERIO+"cemen_80.c","standard");
add_exit("sur",CEMENTERIO+"cemen_90.c","standard");
}
