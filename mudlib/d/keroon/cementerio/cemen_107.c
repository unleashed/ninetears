...
add_exit("oeste",CEMENTERIO+"cemen_106.c","standard");
add_exit("norte",CEMENTERIO+"cemen_96.c","standard");
add_exit("este",CEMENTERIO+"cemen_108.c","standard");
add_exit("sur",CEMENTERIO+"cemen_121.c","standard");
}
