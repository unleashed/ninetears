...
add_exit("oeste",CEMENTERIO+"cemen_139.c","standard");
add_exit("norte",CEMENTERIO+"cemen_128.c","standard");
add_exit("este",CEMENTERIO+"cemen_141.c","standard");
add_exit("sur",CEMENTERIO+"cemen_154.c","standard");
}
