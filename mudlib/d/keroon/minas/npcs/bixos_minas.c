...
void setup()
  ...
  switch(random(4))
  {
    case 0:
      ...
      add_clone(ITEMSMINAS +"pico.c",1);
      add_clone(ITEMSMINAS +"casco_minero.c",1);
      ::init_equip();
      break;
    case 1:     
      ...
      set_gender(1);
      add_clone( ITEMSMINAS +"latigo.c",1);
      add_clone( ITEMSMINAS +"hacha_guardia.c",1);
      add_clone( ITEMSMINAS +"cota_guardia.c",1);
      ::init_equip();
    break;
    case 2:
      set_name("minero");
