...
add_exit("oeste",MINAS+"minas_176.c","standard");
add_exit("noroeste",MINAS+"minas_169.c","standard");
add_exit("este",MINAS+"minas_178.c","standard");
add_exit("sur",MINAS+"minas_191.c","standard");
}
