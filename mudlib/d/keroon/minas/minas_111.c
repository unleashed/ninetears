...
add_exit("oeste",MINAS+"minas_110.c","standard");
add_exit("noroeste",MINAS+"minas_89.c","standard");
add_exit("este",MINAS+"minas_112.c","standard");
add_exit("sur",MINAS+"minas_141.c","standard");
}
