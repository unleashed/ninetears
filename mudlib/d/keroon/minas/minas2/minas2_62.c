...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_87.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_63.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_61.c","standard");
}
