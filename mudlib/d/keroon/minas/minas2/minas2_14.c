...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_02.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_15.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_13.c","standard");
}
