...
void setup() {
   ...
   "estruendo viene del fondo de la mina. A cada paso el aire esta mas viciado.""\n\n");
...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_82.c","standard");
add_exit("sur","d/keroon/minas/minas2/minas2_115.c","standard");
}
