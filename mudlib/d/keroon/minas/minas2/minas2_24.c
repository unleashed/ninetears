...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_40.c","hidden");
add_exit("este","d/keroon/minas/minas2/minas2_25.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_23.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_41.c","standard");
}
