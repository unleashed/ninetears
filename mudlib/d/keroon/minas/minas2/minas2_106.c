...
//Salidas disponibles
add_exit("este","d/keroon/minas/minas2/minas2_107.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_105.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_121.c","standard");
}
