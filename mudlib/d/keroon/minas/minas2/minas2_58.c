...
add_item(({"filon","filones","cobre"}),"El filon de cobre es casi inexistente, casi un recuerdo.\n");
...
//Salidas disponibles
add_exit("este","d/keroon/minas/minas2/minas2_59.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_57.c","standard");
add_exit("noroeste","d/keroon/minas/minas2/minas2_33.c","standard");
}
