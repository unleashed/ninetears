...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_37.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_71.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_69.c","standard");
}
