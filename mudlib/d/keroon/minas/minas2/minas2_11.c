...
void setup() {
  ...
  set_short("%^BOLD%^BLACK%^Minas de Keeroon: %^RESET%^Nivel 2");
   ...
   " Un enorme estruendo viene del fondo de la mina. Necesitar aire fresco y rapido!!!.""\n\n");
...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_27.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_10.c","standard");
}
