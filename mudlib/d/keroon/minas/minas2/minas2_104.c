...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_87.c","standard");
add_exit("sur","d/keroon/minas/minas2/minas2_120.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_105.c","standard");
}
