...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_96.c","standard");
add_exit("sur","d/keroon/minas/minas2/minas2_130.c","standard");
add_exit("noroeste","d/keroon/minas/minas2/minas2_95.c","standard");
}
