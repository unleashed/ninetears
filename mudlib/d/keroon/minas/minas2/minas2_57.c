...
add_item(({"filon","filones","cobre"}),"El filon de cobre comienza a desaparecer, ya casi no hay rastro de el.\n");
...
//Salidas disponibles
add_exit("este","d/keroon/minas/minas2/minas2_58.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_56.c","standard");
}
