...
void setup() {
   ...
   "y carbon. Los obreros se encuentran mas fatigados por la escasez de oxigeno de esta zona. "
...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_86.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_60.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_58.c","standard");
}
