...
add_item(({"filon","filones","cobre"}),"Observando las paredes te encuentras con una pequenya veta de cobre.\n");
...
//Salidas disponibles
add_exit("este","d/keroon/minas/minas2/minas2_45.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_43.c","standard");
}
