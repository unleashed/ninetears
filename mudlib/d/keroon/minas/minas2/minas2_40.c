...
void setup() {
   ...
   "El aire comienza a se hace mas y mas pesado a cada paso.""\n\n");
...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_24.c","hidden");
add_exit("sur","d/keroon/minas/minas2/minas2_77.c","hidden");
}
