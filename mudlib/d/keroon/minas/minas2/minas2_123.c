...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_140.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_124.c","hidden");
add_exit("noroeste","d/keroon/minas/minas2/minas2_108.c","standard");
}
