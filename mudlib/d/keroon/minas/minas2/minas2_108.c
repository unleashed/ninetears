...
//Salidas disponibles
add_exit("noroeste","d/keroon/minas/minas2/minas2_89.c","standard");
add_exit("noreste","d/keroon/minas/minas2/minas2_90.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_123.c","standard");
}
