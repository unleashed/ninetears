...
void setup() {
   ...
   " Un enorme estruendo viene del fondo de la mina. A cada paso el aire esta mas viciado.""\n\n");
...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_01.c","standard");
add_exit("sur","d/keroon/minas/minas2/minas2_28.c","standard");
}
