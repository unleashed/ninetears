...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_40.c","hidden");
add_exit("este","d/keroon/minas/minas2/minas2_78.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_76.c","standard");
}
