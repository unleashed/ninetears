...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_80.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_46.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_44.c","standard");
}
