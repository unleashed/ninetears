...
//Salidas disponibles
add_exit("este","d/keroon/minas/minas2/minas2_47.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_45.c","standard");
add_exit("noreste","d/keroon/minas/minas2/minas2_27.c","standard");
}
