...
void setup() {
   ...
   " Un enorme estruendo viene del fondo de la mina. Notas como te comienza a faltar "
   "el aire.""\n\n");
...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_00.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_10.c","standard");
}