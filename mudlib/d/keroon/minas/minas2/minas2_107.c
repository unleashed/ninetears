...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_88.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_106.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_122.c","standard");
}
