...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_29.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_53.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_51.c","standard");
}
