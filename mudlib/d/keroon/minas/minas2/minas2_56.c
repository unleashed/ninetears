...
add_item(({"filon","filones","cobre"}),"El filon de cobre comienza a ser mas importante aqui, ves fragmentos mas grandes por el suelo.\n");
...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_32.c","standard");
add_exit("sur","d/keroon/minas/minas2/minas2_85.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_57.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_55.c","standard");
}
