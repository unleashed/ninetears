...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_84.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_54.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_52.c","standard");
}
