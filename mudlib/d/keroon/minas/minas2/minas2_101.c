...
void setup() {
   ...
   "estruendo viene del fondo de la mina. Te empieza a faltar la respiracion.""\n\n");
...
//Salidas disponibles
add_exit("oeste","d/keroon/minas/minas2/minas2_100.c","standard");
add_exit("noreste","d/keroon/minas/minas2/minas2_84.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_116.c","standard");
}
