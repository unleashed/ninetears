...
add_item(({"filon","filones","cristales"}),"Las piedras empiezan a escasear, parece que la veta finaliza en esta zona.\n");
...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_90.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_69.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_67.c","standard");
add_exit("noroeste","d/keroon/minas/minas2/minas2_36.c","standard");
}
