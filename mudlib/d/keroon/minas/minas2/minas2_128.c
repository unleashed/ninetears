...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_110.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_127.c","hidden");
add_exit("sudoeste","d/keroon/minas/minas2/minas2_141.c","standard");
}
