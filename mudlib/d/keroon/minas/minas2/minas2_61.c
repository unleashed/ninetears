...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_34.c","standard");
add_exit("este","d/keroon/minas/minas2/minas2_62.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_60.c","standard");
}
