...
void setup() {
   ...
   "de la mina aparecen grandes filones de cobre en los que los mineros trabajan sin "
   "descanso. El aire es mas denso e incluso un susurro al final de la mina puede ser  "
...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_130.c","standard");
add_exit("sur","d/keroon/minas/minas2/minas2_156.c","standard");
}
