...
//Salidas disponibles
;
add_exit("noroeste","d/keroon/minas/minas2/minas2_93.c","standard");
add_exit("noreste","d/keroon/minas/minas2/minas2_94.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_129.c","standard");
}
