...
void setup() {
   ...
   "estruendo viene del fondo de la mina. ¿No creer que deberias salir a la superficie"
   "y respirar un poco?.""\n\n");
...
//Salidas disponibles
add_exit("noroeste","d/keroon/minas/minas2/minas2_03.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_33.c","standard");
}
