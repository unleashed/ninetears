...
//Salidas disponibles
add_exit("norte","d/keroon/minas/minas2/minas2_85.c","standard");
add_exit("sudoeste","d/keroon/minas/minas2/minas2_117.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_118.c","standard");
}
