...
//Salidas disponibles
add_exit("este","d/keroon/minas/minas2/minas2_77.c","hidden");
add_exit("oeste","d/keroon/minas/minas2/minas2_75.c","standard");
add_exit("sudeste","d/keroon/minas/minas2/minas2_94.c","standard");
}
