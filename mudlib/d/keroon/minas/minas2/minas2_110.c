...
//Salidas disponibles
add_exit("sur","d/keroon/minas/minas2/minas2_128.c","standard");
add_exit("oeste","d/keroon/minas/minas2/minas2_109.c","standard");
add_exit("noreste","d/keroon/minas/minas2/minas2_92.c","standard");
