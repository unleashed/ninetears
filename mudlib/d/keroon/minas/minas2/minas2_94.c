...
//Salidas disponibles
add_exit("noroeste","d/keroon/minas/minas2/minas2_76.c","standard");
add_exit("noreste","d/keroon/minas/minas2/minas2_78.c","standard");
add_exit("sudoeste","d/keroon/minas/minas2/minas2_111.c","standard");
}
