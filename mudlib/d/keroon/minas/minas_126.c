...
add_exit("oeste",MINAS+"minas_125.c","standard");
add_exit("norte",MINAS+"minas_96.c","standard");
add_exit("este",MINAS+"minas_127.c","standard");
add_exit("sudeste",MINAS+"minas_148.c","standard");
}
