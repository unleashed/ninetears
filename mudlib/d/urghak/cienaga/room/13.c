...
");
  add_exit ("noreste","/d/urghak/cienaga/room/18.c","door");
  add_exit ("este","/d/urghak/cienaga/room/19.c","door");
  add_exit ("sur","/d/urghak/cienaga/room/14.c","door");
