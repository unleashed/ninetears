...
");
  add_exit ("oeste","/d/urghak/cienaga/room/26.c","door");
  add_exit ("norte","/d/urghak/cienaga/room/28.c","door");
  add_exit ("sudeste","/d/urghak/cienaga/room/31.c","door");
