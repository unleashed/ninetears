...
");
  add_exit ("sudoeste","/d/urghak/cienaga/room/33.c","door");
  add_exit ("este","/d/urghak/cienaga/room/39.c","door");
  add_exit ("norte","/d/urghak/cienaga/room/34.c","door");
