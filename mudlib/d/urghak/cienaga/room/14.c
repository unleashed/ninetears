...
");
  add_exit ("norte","/d/urghak/cienaga/room/13.c","door");
  add_exit ("este","/d/urghak/cienaga/room/20.c","door");
  add_exit ("sudeste","/d/urghak/cienaga/room/21.c","door");
