...
");
  add_exit ("oeste","/d/urghak/cienaga/room/03.c","door");
  add_exit ("noreste","/d/urghak/cienaga/room/05.c","door");
  add_exit ("sudeste","/d/urghak/cienaga/room/06.c","door");
