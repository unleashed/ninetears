...
");
  add_exit ("noroeste","/d/urghak/cienaga/room/32.c","door");
  add_exit ("noreste","/d/urghak/cienaga/room/37.c","door");
  add_exit ("este","/d/urghak/cienaga/room/38.c","door");
  add_exit ("sur","/d/urghak/cienaga/room/35.c","door");
