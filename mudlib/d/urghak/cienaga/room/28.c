...
");
  add_exit ("noroeste","/d/urghak/cienaga/room/24.c","door");
  add_exit ("oeste","/d/urghak/cienaga/room/25.c","door");
  add_exit ("sur","/d/urghak/cienaga/room/29.c","door");
  add_exit ("noreste","/d/urghak/cienaga/room/30.c","door");
