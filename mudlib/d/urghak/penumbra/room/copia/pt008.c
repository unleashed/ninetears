...
void setup()
{
  ...
  set_exit_color("red");
  set_short("Intersección sobre la %^BLACK%^BOLD%^Grieta Eterna%^RESET%^");
  set_long("Intersección sobre la %^BLACK%^BOLD%^Grieta Eterna%^RESET%^\n\n"
  ...
  add_exit("sur", ROOM+"pt004.c", "path");
  add_exit("oeste", ROOM+"pt007.c", "path");
