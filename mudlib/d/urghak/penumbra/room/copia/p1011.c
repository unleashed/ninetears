...
void setup()
{
  ...
  "tribus. Al sur se encuentra la sala de la Guardia de Elite de "
  "Penumbra.\n\n");
  add_item("grieta","La Grieta Eterna... un profundo abismo sin fin "
  "conocido.\n");
  add_exit("oeste", ROOM+"p1010.c", "path");
  add_exit("este", ROOM+"p1012.c", "path");  
  add_clone(NPC+"esclavo.c",random(2));
  add_exit("sur", ROOM+"g100.c", "path");  
