...
void setup()
{
   ...
   add_exit("oeste", POBLADO + "poblado6.c", "path");
   add_exit("este", POBLADO + "poblado4.c", "path");
   add_exit("norte", POBLADO + "poblado18.c", "path");
   add_exit("sur", POBLADO + "poblado19.c", "path");
