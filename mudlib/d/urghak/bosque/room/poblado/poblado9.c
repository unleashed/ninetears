...
void setup()
{
   ...
   add_exit("norte", POBLADO + "poblado8.c", "path");
   add_exit("sur", POBLADO + "poblado10.c", "path");
   add_exit("este", POBLADO + "poblado11.c", "path");
   add_exit("oeste", POBLADO + "poblado12.c", "path");
