...
void setup()
{
	...
	add_exit("sudoeste",ROOMORMPN"pasto_ormerod_95.c","plain");
	add_exit("norte",ROOMORMPN"pasto_ormerod_101.c","plain");
	add_exit("este",ROOMORMPN"pasto_ormerod_106.c","plain");
}