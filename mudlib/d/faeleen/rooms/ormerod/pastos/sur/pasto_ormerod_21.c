...
void setup()
{
	...
	add_exit("sudeste",ROOMORMPS"pasto_ormerod_27.c","plain");
	add_exit("oeste",ROOMORMPS"pasto_ormerod_16.c","plain");
	add_exit("noreste",ROOMORMPS"pasto_ormerod_28.c","plain");
}