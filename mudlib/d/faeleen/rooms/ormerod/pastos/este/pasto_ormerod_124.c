...
void setup()
{
	...
	add_exit("sur",ROOMORMPE"pasto_ormerod_123.c","plain");
	add_exit("noroeste",ROOMORMPE"pasto_ormerod_122.c","plain");
	add_exit("sudoeste",ROOMORMPE"pasto_ormerod_121.c","plain");
}