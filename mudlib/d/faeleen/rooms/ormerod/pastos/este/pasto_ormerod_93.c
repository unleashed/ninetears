...
void setup()
{
	...
	add_exit("sudoeste",ROOMORMPE"pasto_ormerod_85.c","plain");
	add_exit("noroeste",ROOMORMPE"pasto_ormerod_86.c","plain");
	add_exit("sudeste",ROOMORMPE"pasto_ormerod_98.c","plain");
}