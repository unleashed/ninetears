...
void setup()
{
	...
	add_exit("sudeste",ROOMORMPE"pasto_ormerod_122.c","plain");
	add_exit("oeste",ROOMORMPE"pasto_ormerod_109.c","plain");
	add_exit("sudoeste",ROOMORMPE"pasto_ormerod_108.c","plain");
}