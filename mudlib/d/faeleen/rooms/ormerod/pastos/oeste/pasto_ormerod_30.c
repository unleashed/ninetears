...
void setup()
{
	...
	add_exit("noreste",ROOMORMPO"pasto_ormerod_37.c","plain");
	add_exit("sudoeste",ROOMORMPO"pasto_ormerod_24.c","plain");
	add_exit("sudeste",ROOMORMPO"pasto_ormerod_36.c","plain");
}