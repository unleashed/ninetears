...
add_exit("norte","/d/adiel/room/cultivos/room/olivares1.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/acequia5.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/olivares2.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/olivares10.c","road");
}