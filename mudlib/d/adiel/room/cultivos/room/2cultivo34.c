...
add_exit("oeste","/d/adiel/room/cultivos/room/2cultivo33.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo26.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo35.c","road");
}