...
add_exit("norte","/d/adiel/room/cultivos/room/olivares13.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/acequia8.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/olivares14.c","road");
}