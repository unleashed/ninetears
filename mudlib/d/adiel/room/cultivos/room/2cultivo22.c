...
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo28.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/2cultivo21.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/2cultivo14.c","road");
}