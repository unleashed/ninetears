...
add_exit("oeste","/d/adiel/room/cultivos/room/acequia2.c","road");
add_exit("este","/d/adiel/room/cultivos/room/arrozal16.c","road"); 
add_exit("sudeste","/d/adiel/room/cultivos/room/arrozal20.c.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/arrozal12.c","road");
}