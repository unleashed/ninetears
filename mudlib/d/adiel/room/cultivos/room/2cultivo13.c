...
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo7.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo20.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/2cultivo12.c","road");
}