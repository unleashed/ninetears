...
add_clone("/d/adiel/room/cultivos/npc/perro.c",2);
add_clone("/d/adiel/room/cultivos/npc/pescador.c",4);
add_exit("noroeste","/d/adiel/room/cultivos/room/ribera11.c","road");
add_exit("sudeste","/d/adiel/room/cultivos/room/ribera13.c","road"); 
}