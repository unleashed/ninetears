...
add_exit("este","/d/adiel/room/cultivos/room/1cultivo20.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/1cultivo15.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/1cultivo10.c","road");
}