...
add_exit("este","/d/adiel/room/cultivos/room/acequia2.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/arrozal7.c.c","road");
add_exit("noroeste","/d/adiel/room/cultivos/room/arrozal3.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/arrozal11.c","road");
}