...
add_exit("norte","/d/adiel/room/cultivos/room/puente5.c.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/arrozal19.c","road"); 
add_exit("sur","/d/adiel/room/cultivos/room/camino47.c.c","road");
}