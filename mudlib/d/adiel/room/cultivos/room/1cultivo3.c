...
add_exit("sur","/d/adiel/room/cultivos/room/1cultivo4.c","road");
add_exit("sudeste","/d/adiel/room/cultivos/room/1cultivo8.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/1cultivo2.c","road");
}