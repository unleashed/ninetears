...
add_exit("oeste","/d/adiel/room/cultivos/room/olivares2.c","road");
add_exit("este","/d/adiel/room/cultivos/room/olivares4.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/olivares7.c","road");
}