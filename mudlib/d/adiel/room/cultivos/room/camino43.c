...
add_exit("este","/d/adiel/room/cultivos/room/ribera30.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/camino44.c","road"); 
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo2.c","road");
}