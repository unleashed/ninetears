...
set_long("%^GREEN%^Camino %^RESET%^\n\n Te encuentras"
    ...
    "debido al ir y venir de los agricultores con sus carros y animales.\n\n");
          
add_clone("/d/adiel/room/cultivos/npc/paseante.c",1);
add_clone("/d/adiel/room/cultivos/npc/rata.c",1);
add_exit("noroeste","/d/adiel/room/cultivos/room/camino3.c","road");
add_exit("este","/d/adiel/room/cultivos/room/camino5.c","road"); 
}