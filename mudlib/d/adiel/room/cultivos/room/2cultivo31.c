...
add_exit("sudoeste","/d/adiel/room/cultivos/room/2cultivo40.c","road");
add_exit("noroeste","/d/adiel/room/cultivos/room/2cultivo24.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/2cultivo25.c","road");
}