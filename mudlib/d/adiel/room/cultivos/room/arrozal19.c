...
add_exit("este","/d/adiel/room/cultivos/room/puente6.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/arrozal18.c","road"); 
add_exit("sudoeste","/d/adiel/room/cultivos/room/arrozal22.c.c","road");
add_exit("noroeste","/d/adiel/room/cultivos/room/arrozal14.c","road");
}