...
add_exit("este","/d/adiel/room/cultivos/room/1cultivo13.c","road");
add_exit("noroeste","/d/adiel/room/cultivos/room/1cultivo3.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/1cultivo5.c","road");
}