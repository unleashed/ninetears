...
add_exit("oeste","/d/adiel/room/cultivos/room/olivares4.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo4.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/olivares9.c","road");
}