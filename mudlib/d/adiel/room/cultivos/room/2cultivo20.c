...
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo26.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/2cultivo19.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo22.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo13.c","road");
}