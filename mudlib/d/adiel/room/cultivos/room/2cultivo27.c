...
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo21.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/2cultivo28.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo26.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo35.c","road");
}