...
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo36.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/2cultivo27.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo22.c","road");
}