...
add_exit("este","/d/adiel/room/cultivos/room/2cultivo5.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo11.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/olivares5.c","road");
}