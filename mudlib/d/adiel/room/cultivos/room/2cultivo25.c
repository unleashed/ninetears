...
add_exit("sudoeste","/d/adiel/room/cultivos/room/2cultivo31.c","road");
add_exit("sudeste","/d/adiel/room/cultivos/room/2cultivo32.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo18.c","road");
}