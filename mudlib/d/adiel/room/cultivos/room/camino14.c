...
add_exit("oeste","/d/adiel/room/cultivos/room/camino13.c","road");
add_exit("este","/d/adiel/room/cultivos/room/camino15.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/puente1.c","road"); 
}