...
add_exit("norte","/d/adiel/room/cultivos/room/arrozal11.c","road");
add_exit("sudeste","/d/adiel/room/cultivos/room/1cultivo18.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/1cultivo7.c","road");
}