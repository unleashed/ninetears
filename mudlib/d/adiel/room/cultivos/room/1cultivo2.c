...
add_exit("sudoeste","/d/adiel/room/cultivos/room/1cultivo3.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/1cultivo1.c","road");
add_exit("noroeste","/d/adiel/room/cultivos/room/camino7.c","road");
}