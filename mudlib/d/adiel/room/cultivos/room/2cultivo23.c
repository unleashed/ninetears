...
add_exit("noreste","/d/adiel/room/cultivos/room/2cultivo16.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo24.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/2cultivo29.c","road");
}