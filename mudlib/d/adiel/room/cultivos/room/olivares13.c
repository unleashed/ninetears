...
add_exit("norte","/d/adiel/room/cultivos/room/olivares10.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/acequia7.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/olivares11.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/olivares15.c","road");
}