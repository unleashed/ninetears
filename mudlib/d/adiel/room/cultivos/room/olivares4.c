...
add_exit("oeste","/d/adiel/room/cultivos/room/olivares3.c","road");
add_exit("este","/d/adiel/room/cultivos/room/olivares5.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/olivares8.c","road");
}