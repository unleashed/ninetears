...
add_exit("este","/d/adiel/room/cultivos/room/arrozal5.c","road");
add_exit("sudeste","/d/adiel/room/cultivos/room/arrozal9.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/arrozal1.c","road");
}