...
add_clone("/d/adiel/room/cultivos/npc/abeja.c",2);
add_clone("/d/adiel/room/cultivos/npc/pescador.c",1);
add_exit("oeste","/d/adiel/room/cultivos/room/ribera14.c","road");
add_exit("sudeste","/d/adiel/room/cultivos/room/ribera16.c","road"); 
}