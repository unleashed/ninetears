...
add_exit("este","/d/adiel/room/cultivos/room/2cultivo17.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo10.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/2cultivo23.c","road");
}