...
add_exit("oeste","/d/adiel/room/cultivos/room/olivares1.c","road");
add_exit("este","/d/adiel/room/cultivos/room/olivares3.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/olivares6.c","road");
}