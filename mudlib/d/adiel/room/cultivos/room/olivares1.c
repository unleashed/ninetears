...
add_exit("oeste","/d/adiel/room/cultivos/room/acequia4.c","road");
add_exit("este","/d/adiel/room/cultivos/room/olivares2.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/olivares6.c","road");
}