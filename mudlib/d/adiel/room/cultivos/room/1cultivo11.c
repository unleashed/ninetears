...
add_exit("norte","/d/adiel/room/cultivos/room/arrozal10.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/1cultivo12.c","road");
add_exit("este","/d/adiel/room/cultivos/room/1cultivo17.c","road");
}