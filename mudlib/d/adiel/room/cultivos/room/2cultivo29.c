...
add_exit("noreste","/d/adiel/room/cultivos/room/2cultivo23.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo30.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/2cultivo37.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo38.c","road");
}