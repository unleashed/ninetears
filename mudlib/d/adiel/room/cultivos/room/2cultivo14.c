...
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo9.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo15.c","road");
add_exit("sudoeste","/d/adiel/room/cultivos/room/2cultivo22.c","road");
}