...
add_exit("este","/d/adiel/room/cultivos/room/camino43.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/camino45.c","road"); 
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo1.c","road");
}