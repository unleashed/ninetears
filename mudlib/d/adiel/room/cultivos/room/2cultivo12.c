...
add_exit("noroeste","/d/adiel/room/cultivos/room/2cultivo6.c","road");
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo19.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo13.c","road");
}