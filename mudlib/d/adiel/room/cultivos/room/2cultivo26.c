...
add_exit("sur","/d/adiel/room/cultivos/room/2cultivo34.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/2cultivo20.c","road");
add_exit("este","/d/adiel/room/cultivos/room/2cultivo27.c","road");
}