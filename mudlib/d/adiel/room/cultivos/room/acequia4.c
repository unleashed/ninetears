...
add_exit("sur","/d/adiel/room/cultivos/room/acequia5.c","road");
add_exit("noreste","/d/adiel/room/cultivos/room/acequia3.c","road");
add_exit("oeste","/d/adiel/room/cultivos/room/1cultivo17.c","road");
add_exit("este","/d/adiel/room/cultivos/room/olivares1.c","road");
}