...
add_exit("sur","/d/adiel/room/cultivos/room/acequia6.c","road");
add_exit("norte","/d/adiel/room/cultivos/room/acequia4.c","road");
add_exit("este","/d/adiel/room/cultivos/room/olivares6.c","road");
}