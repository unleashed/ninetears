...
{
     set_name("caballero");
     set_short("Guardia desterrado de Zumelzu");
     add_alias("humano");
     add_alias("caballero");
     set_al(0);
     set_gender(1);
     set_main_plural("Guardias desterrados de Zumelzu");
     add_plural("guardias");
     add_plural("humanos");
     ...
     set_race("human");
     set_long("Es un enano de la guardia de Zumelzu, su delito fue no ayudar "
