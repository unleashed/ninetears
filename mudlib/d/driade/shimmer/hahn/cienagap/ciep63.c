...
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep70.c","standard");
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep62.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep64.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep66.c","standard");
}