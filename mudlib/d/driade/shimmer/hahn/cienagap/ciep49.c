...
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep48.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep50.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep0.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep45.c","standard");
}