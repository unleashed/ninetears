...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep26.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep27.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep85.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienagap/ciep54.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep24.c","standard");
}