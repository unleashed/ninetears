...
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep59.c","standard");
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep56.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep58.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep65.c","standard");
}