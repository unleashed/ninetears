...
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep34.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep33.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep31.c","standard");
}