...
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep13.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep12.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep10.c","standard");
}