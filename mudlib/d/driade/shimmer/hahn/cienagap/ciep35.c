...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep36.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep34.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep39.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep42.c","standard");
}