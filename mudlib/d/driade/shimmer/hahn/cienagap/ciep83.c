...
add_exit("oeste","/d/driade/shimmer/hahn/cienagap/ciep86.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep84.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep82.c","standard");
}