...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep69.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep73.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep67.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep78.c","standard");
}