...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep32.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep30.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep46.c","standard");
}