...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep49.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep51.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie32.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie33.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/arbol_ameline.c","standard");
}