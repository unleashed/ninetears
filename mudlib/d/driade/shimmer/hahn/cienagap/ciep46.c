...
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep31.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep41.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienagap/ciep47.c","standard");
}