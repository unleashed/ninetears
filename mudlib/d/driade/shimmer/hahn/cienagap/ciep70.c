...
add_clone("/d/driade/shimmer/hahn/npcs/cienaga2.c",0);

add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep61.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep71.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep63.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep69.c","standard");
}