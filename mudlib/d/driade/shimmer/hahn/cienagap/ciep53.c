...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep28.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep54.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep52.c","standard");
}