...
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep35.c","standard");
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep6.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep32.c","standard");
}