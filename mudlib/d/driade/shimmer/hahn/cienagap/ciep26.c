...
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep23.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienagap/ciep27.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep25.c","standard");
}