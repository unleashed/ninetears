...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep1.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep10.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep8.c","standard");
}