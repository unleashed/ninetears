...
add_exit("oeste","/d/driade/shimmer/hahn/cienagap/ciep2.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep4.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep1.c","standard");
