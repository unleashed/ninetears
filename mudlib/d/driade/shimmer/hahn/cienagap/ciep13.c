...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep14.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep7.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep11.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep38.c","standard");
}