...
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep6.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep8.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep13.c","standard");
}