...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep71.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep79.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienagap/ciep74.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep73.c","standard");
}