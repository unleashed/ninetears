...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep30.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep28.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep47.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep48.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep50.c","standard");
}