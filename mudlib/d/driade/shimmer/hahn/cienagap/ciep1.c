...
add_exit("oeste","/d/driade/shimmer/hahn/rio/rio39.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep2.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep3.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep9.c","standard");
}