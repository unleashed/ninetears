...
add_exit("oeste","/d/driade/shimmer/hahn/cienagap/ciep46.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep29.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep44.c","standard");
}