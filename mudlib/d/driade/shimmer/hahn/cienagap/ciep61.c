...
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep60.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep70.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienagap/ciep62.c","standard");
