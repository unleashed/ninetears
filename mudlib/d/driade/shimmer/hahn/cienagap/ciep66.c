...
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep65.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep63.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienagap/ciep76.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep67.c","standard");
}