...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep57.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep64.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep66.c","standard");
}