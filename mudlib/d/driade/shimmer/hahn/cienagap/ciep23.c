...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep22.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep26.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep24.c","standard");
}