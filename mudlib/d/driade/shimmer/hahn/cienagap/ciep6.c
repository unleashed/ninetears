...
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep34.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep7.c","standard");
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep5.c","standard");
}