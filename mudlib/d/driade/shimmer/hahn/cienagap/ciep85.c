...
add_exit("noroeste","/d/driade/shimmer/hahn/rio/rio27.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep25.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep84.c","standard");
}