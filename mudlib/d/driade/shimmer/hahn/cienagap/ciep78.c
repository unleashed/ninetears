...
add_exit("oeste","/d/driade/shimmer/hahn/cienagap/ciep75.c","standard");
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep68.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienagap/ciep77.c","standard");
}