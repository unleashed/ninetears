...
add_exit("norte","/d/driade/shimmer/hahn/cienagap/ciep46.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep40.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienagap/ciep45.c","standard");
}