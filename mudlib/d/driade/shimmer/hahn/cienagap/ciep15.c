...
add_exit("noroeste","/d/driade/shimmer/hahn/cienagap/ciep16.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep18.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienagap/ciep14.c","standard");
}