...
{
   set_light(80);
   set_short("%^CYAN%^Banco de Anduar%^RESET%^");
   set_long("Estas en el banco de Anduar. No parece que tenga muchos clientes. "
...
add_exit("southwest", ANDUAR+"enbanco", "path");
      ...
      else
      {
         if (clientes<10)
         {
            ...
            switch(tipo)
            {
               ...
               case 1: clientela[clientes]=new(NPC+"granjero.c");
                       clientela[clientes]->move(this_object()); break;
