...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie78.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie13.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie11.c","standard");
}