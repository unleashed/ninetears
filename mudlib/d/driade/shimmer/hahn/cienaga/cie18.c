...
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie17.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/muralla/mur10.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie19.c","standard");
}