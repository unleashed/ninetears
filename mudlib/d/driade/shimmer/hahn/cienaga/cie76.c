...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie75.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie72.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie77.c","standard");
}