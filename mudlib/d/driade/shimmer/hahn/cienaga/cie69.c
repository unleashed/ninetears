...
add_exit("noroeste","/d/driade/shimmer/hahn/cienaga/cie33.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienaga/arbol_ameline.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienaga/cie32.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie70.c","standard");
}