...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie73.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie11.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie9.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/rio/rio6.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/rio/encrucijada_rio_rojo.c","standard");
}