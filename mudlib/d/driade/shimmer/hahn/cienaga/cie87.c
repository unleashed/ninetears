...
add_exit("noroeste","/d/driade/shimmer/hahn/cienaga/cie86.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienaga/cie91.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie88.c","standard");
}