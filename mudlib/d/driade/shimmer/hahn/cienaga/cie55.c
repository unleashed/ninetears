...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie54.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie51.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie56.c","standard");
}