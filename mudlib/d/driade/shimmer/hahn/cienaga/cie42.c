...
add_exit("oeste","/d/driade/shimmer/hahn/rio/rio41.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie41.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie43.c","standard");
