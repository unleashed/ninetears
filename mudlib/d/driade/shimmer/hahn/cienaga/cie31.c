...
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie32.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie30.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie74.c","standard");
