...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie68.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie9.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie7.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/rio/rio4.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/rio/encrucijada_rio_rojo.c","standard");
}