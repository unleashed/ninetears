...
add_exit("noreste","/d/driade/shimmer/hahn/cienagap/ciep0.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie34.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/arbol_ameline.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie69.c","standard");
}