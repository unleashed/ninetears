...
add_clone("/d/driade/shimmer/hahn/npcs/varios_cienaga1.c",0);
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie90.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie87.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie19.c","standard");
}