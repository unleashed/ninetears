...
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie8.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie10.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/rio/encrucijada_rio_rojo.c","standard");
}