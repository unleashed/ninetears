...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie70.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie67.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie72.c","standard");
}