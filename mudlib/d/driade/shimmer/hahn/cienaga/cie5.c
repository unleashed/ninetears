...
add_exit("sur","/d/driade/shimmer/hahn/rio/rio1.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie6.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie4.c","standard");
}