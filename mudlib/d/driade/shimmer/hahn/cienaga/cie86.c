...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie85.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie82.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie87.c","standard");
}