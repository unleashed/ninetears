...
add_exit("noroeste","/d/driade/shimmer/hahn/cienaga/cie91.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie18.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienaga/cie20.c","standard");
}