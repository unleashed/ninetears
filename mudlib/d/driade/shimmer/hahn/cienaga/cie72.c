...
add_exit("noroeste","/d/driade/shimmer/hahn/cienaga/cie71.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienaga/cie76.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie73.c","standard");
}