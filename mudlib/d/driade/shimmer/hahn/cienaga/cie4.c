...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie57.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie5.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie3.c","standard");
}