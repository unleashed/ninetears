...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie52.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/muralla/mur71.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie3.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie1.c","standard");
}