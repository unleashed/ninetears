...
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie26.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie24.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie89.c","standard");
