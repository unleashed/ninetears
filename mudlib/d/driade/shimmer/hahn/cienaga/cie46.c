...
add_exit("noroeste","/d/driade/shimmer/hahn/cienaga/cie45.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienaga/cie50.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie47.c","standard");
}