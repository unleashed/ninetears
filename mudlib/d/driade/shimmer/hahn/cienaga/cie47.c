...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie46.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/muralla/mur69.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie1.c","standard");
}