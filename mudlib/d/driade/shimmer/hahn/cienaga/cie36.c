...
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie37.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie35.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie58.c","standard");
