...
add_exit("noroeste","/d/driade/shimmer/hahn/cienaga/cie55.c","standard");
add_exit("noreste","/d/driade/shimmer/hahn/cienaga/cie60.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie57.c","standard");
}