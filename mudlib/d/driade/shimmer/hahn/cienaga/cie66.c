...
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie65.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie61.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie67.c","standard");
}