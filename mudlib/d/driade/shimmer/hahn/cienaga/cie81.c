...
add_clone("/d/driade/shimmer/hahn/npcs/varios_cienaga1.c",3);
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie80.c","standard");
add_exit("sudoeste","/d/driade/shimmer/hahn/cienaga/cie77.c","standard");
add_exit("sudeste","/d/driade/shimmer/hahn/cienaga/cie82.c","standard");
}