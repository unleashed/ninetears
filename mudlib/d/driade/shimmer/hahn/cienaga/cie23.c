...
add_exit("este","/d/driade/shimmer/hahn/rio/rio14.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie24.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie22.c","standard");
}