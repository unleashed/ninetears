...
add_exit("sur","/d/driade/shimmer/hahn/rio/rio9.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie14.c","standard");
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie12.c","standard");
}