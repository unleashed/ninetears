...
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie15.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie17.c","standard");
add_exit("norte","/d/driade/shimmer/hahn/cienaga/cie88.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/muralla/mur8.c","standard");
}