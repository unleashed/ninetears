...
add_exit("oeste","/d/driade/shimmer/hahn/cienaga/cie30.c","standard");
add_exit("este","/d/driade/shimmer/hahn/cienaga/cie28.c","standard");
add_exit("sur","/d/driade/shimmer/hahn/cienaga/cie79.c","standard");
