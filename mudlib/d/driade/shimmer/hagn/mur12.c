...
void setup() {
   ...
   set_exit_color("red");
   set_light(50);
   set_short("Muralla Este del Reino de %^BOLD%^%^CYAN%^Hagn %^RESET%^");
   set_long("Muralla Este del Reino de %^BOLD%^%^CYAN%^Hagn %^RESET%^\n\nA tu lado se erige una inmensa muralla que recorre serpenteando la llanura hasta donde "
   ...
   "camino al lado del cual discurre un rio de agua rojiza.\n\n");

add_exit("norte",HAGN+"rio10.c","standard");
add_exit("sudoeste",HAGN+"mur11.c","standard");
add_exit("noreste",HAGN+"mur13.c","standard");
