...
void setup() {
   ...
   set_zone("rio");
   set_light(50);
   set_short("Camino paralelo al %^BOLD%^%^RED%^Rio Rojo%^RESET%^ : Zona Oeste");
   set_long("Camino paralelo al %^BOLD%^%^RED%^Rio Rojo%^RESET%^ : Zona Oeste\n\n"
...
add_clone(NPCS+"varios_rio.c",2);

add_exit("sudoeste",HAGN+"rio37.c","standard");
add_exit("este",HAGN+"rio35.c","standard");
