...
void setup() {
   ...
   "material, un mundo frio y asolado, quizas como el que se encuentra tras la propia muralla. Al norte "
   "puedes ver una enorme puerta en la roca de unos dos metros de alto, tras ella se abre una vasta llanura "
   "fangosa sobre la cual flota una bruma gelida y tenebrosa\n\n");

add_clone(NPCS+"hiena.c",1);

add_exit("norte",HAGN+"cie17.c","standard");
add_exit("oeste",HAGN+"mur7.c","standard");
add_exit("este",HAGN+"mur9.c","standard");
