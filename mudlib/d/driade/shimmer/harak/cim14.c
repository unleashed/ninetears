...
add_exit("norte",HARAK+"cim13.c","standard");
add_exit("noreste",HARAK+"cim10.c","standard");
add_exit("este",HARAK+"cim17.c","standard");
add_exit("sudeste",HARAK+"cim16.c","standard");
add_exit("sur",HARAK+"cim15.c","standard");
}