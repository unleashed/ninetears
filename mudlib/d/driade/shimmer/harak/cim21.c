...
add_exit("oeste",   HARAK+"cim16.c","standard");
add_exit("noroeste",HARAK+"cim17.c","standard");
add_exit("norte",   HARAK+"cim20.c","standard");
add_exit("sudeste", HARAK+"cim22.c","standard");
}