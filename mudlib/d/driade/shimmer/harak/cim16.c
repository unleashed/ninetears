...
add_exit("oeste",HARAK+"cim15.c","standard");
add_exit("noroeste",HARAK+"cim14.c","standard");
add_exit("norte",HARAK+"cim17.c","standard");
add_exit("noreste",HARAK+"cim20.c","standard");
add_exit("este",HARAK+"cim21.c","standard");
}