...
add_exit("oeste",   HARAK+"cim13.c","standard");
add_exit("este",    HARAK+"cim19.c","standard");
add_exit("sudeste", HARAK+"cim20.c","standard");
add_exit("sur",     HARAK+"cim17.c","standard");
add_exit("sudoeste",HARAK+"cim14.c","standard");
}