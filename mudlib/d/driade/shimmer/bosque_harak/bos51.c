...
add_exit("noroeste",BOSQUEHARAK+"bos52.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos56.c","standard");
add_exit("sur",BOSQUEHARAK+"bos50.c","standard");
add_exit("noreste",BOSQUEHARAK+"bos35.c","standard");
