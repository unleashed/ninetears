...
add_exit("noroeste",BOSQUEHARAK+"bos34.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos51.c","standard");
add_exit("sur",BOSQUEHARAK+"bos36.c","standard");
add_exit("noreste",BOSQUEHARAK+"bos26.c","standard");
