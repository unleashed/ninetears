...
add_clone(NPCS+"varios_bosque_harak.c",3);

add_exit("noroeste",BOSQUEHARAK+"bos25.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos7.c","standard");
add_exit("sudeste",BOSQUEHARAK+"bos9.c","standard");
