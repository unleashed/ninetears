...
add_exit("norte",BOSQUEHARAK+"bos58.c","standard");
add_exit("oeste",BOSQUEHARAK+"bos59.c","standard");
add_exit("sur",BOSQUEHARAK+"bos44.c","standard");
add_exit("noreste",BOSQUEHARAK+"bos46.c","standard");
