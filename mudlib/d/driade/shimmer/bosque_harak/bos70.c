...
add_exit("noroeste",BOSQUEHARAK+"bos89.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos69.c","standard");
add_exit("noreste",BOSQUEHARAK+"bos87.c","standard");
add_exit("sudeste",BOSQUEHARAK+"bos71.c","standard");
