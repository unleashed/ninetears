...
add_clone(NPCS+"varios_bosque_harak.c",2);

add_exit("noroeste",BOSQUEHARAK+"bos7.c","standard");
add_exit("oeste",BOSQUEHARAK+"bos3.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos2.c","standard");
add_exit("sudeste",BOSQUEHARAK+"camino7.c","standard");
