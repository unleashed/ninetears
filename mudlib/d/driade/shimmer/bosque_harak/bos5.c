...
add_exit("norte",BOSQUEHARAK+"bos38.c","standard");
add_exit("noreste",BOSQUEHARAK+"bos6.c","standard");
add_exit("sudeste",BOSQUEHARAK+"bos4.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos47.c","standard");
