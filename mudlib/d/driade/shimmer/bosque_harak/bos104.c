...
add_exit("norte",BOSQUEHARAK+"bos103.c","standard");
add_exit("sur",BOSQUEHARAK+"bos105.c","standard");
add_exit("sudoeste",BOSQUEHARAK+"bos99.c","standard");
add_exit("este",BOSQUEHARAK+"bos109.c","standard");
}