...
void setup()
{
   ...
   add_exit("este",       CLOACASBRE + "clo44", "corridor");
   add_exit("noroeste",   CLOACASBRE + "clo2",  "corridor");
   add_exit("sudoeste",   CLOACASBRE + "clo29", "corridor");
...
void cloaca(string tapa)
{
   ...
   this_player()->move(BRETHEM + "gen14.c");
   this_player()->look_me();
   return 1;
}
