...
add_exit("oeste",            BRETHEM + "parque_piedra3.c","standard");
add_exit("este",             BRETHEM + "mercado22.c","standard");
add_exit("norte",            BRETHEM + "parque_piedra2.c","standard");
add_exit("sudoeste",         BRETHEM + "parque_piedra4.c","standard");
