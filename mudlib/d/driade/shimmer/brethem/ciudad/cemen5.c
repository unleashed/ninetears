...
add_exit("noroeste",   BRETHEM + "cemen46.c","standard");
add_exit("noreste",    BRETHEM + "cemen45.c","standard");
add_exit("sur",        BRETHEM + "cemen13.c","standard");
add_exit("este",       BRETHEM + "cemen4.c","standard");
