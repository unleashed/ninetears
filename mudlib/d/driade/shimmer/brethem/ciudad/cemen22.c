...
add_exit("noroeste",   BRETHEM + "cemen14.c","standard");
add_exit("norte",      BRETHEM + "cemen13.c","standard");
add_exit("sur",        BRETHEM + "cemen32.c","standard");
add_exit("este",       BRETHEM + "cemen21.c","standard");
