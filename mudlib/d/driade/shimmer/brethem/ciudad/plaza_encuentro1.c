...
add_exit("oeste",     BRETHEM + "plaza_encuentro3.c","standard");
add_exit("norte",     BRETHEM + "plaza_encuentro2.c","standard");
add_exit("este",      BRETHEM + "gen19.c","standard");
add_exit("sur",       BRETHEM + "gen20.c","standard");
