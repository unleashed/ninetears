...
add_exit("oeste",      BRETHEM + "cemen35.c","standard");
add_exit("este",       BRETHEM + "cemen33.c","standard");
add_exit("noroeste",   BRETHEM + "cemen25.c","standard");
add_exit("noreste",    BRETHEM + "cemen23.c","standard");
add_exit("sur",        BRETHEM + "cemen40.c","standard");
