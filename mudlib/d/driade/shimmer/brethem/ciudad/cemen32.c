...
add_exit("norte",      BRETHEM + "cemen22.c","standard");
add_exit("noroeste",   BRETHEM + "cemen23.c","standard");
add_exit("oeste",      BRETHEM + "cemen33.c","standard");
add_exit("sudoeste",   BRETHEM + "cemen39.c","standard");
add_exit("este",       BRETHEM + "cemen31.c","standard");
