...
add_exit("noroeste",   BRETHEM + "cemen10.c","standard");
add_exit("oeste",      BRETHEM + "cemen19.c","standard");
add_exit("sudoeste",   BRETHEM + "cemen29.c","standard");
add_exit("sur",        BRETHEM + "cemen28.c","standard");
