...
add_exit("norte",      BRETHEM + "cemen6.c","standard");
add_exit("oeste",      BRETHEM + "cemen15.c","standard");
add_exit("sudeste",    BRETHEM + "cemen22.c","standard");
add_exit("sudoeste",   BRETHEM + "cemen24.c","standard");
