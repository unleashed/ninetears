...
add_exit("norte",      BRETHEM + "cemen10.c","standard");
add_exit("noreste",    BRETHEM + "cemen9.c","standard");
add_exit("oeste",      BRETHEM + "cemen20.c","standard");
add_exit("este",       BRETHEM + "cemen18.c","standard");
add_exit("sudeste",    BRETHEM + "cemen28.c","standard");
add_exit("sur",        BRETHEM + "cemen29.c","standard");
