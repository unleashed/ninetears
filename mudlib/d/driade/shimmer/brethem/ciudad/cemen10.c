...
add_exit("norte",      BRETHEM + "cemen2.c","standard");
add_exit("sur"  ,      BRETHEM + "cemen19.c","standard");
add_exit("este",       BRETHEM + "cemen9.c","standard");
add_exit("oeste",      BRETHEM + "cemen11.c","standard");
add_exit("sudeste",    BRETHEM + "cemen18.c","standard");
