...
add_exit("oeste",        BRETHEM + "parque2.c","standard");
add_exit("este",         BRETHEM + "parque8.c","standard");
add_exit("norte",        BRETHEM + "gen4.c","standard");
add_exit("sur",          BRETHEM + "parque5.c","standard");
