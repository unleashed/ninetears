...
add_exit("norte",ZHYRKHOM+"min41.c","standard");
add_exit("sur",ZHYRKHOM+"min39.c","standard");
add_exit("noroeste",ZHYRKHOM+"min96.c","standard");
add_exit("sudoeste",ZHYRKHOM+"min43.c","standard");
