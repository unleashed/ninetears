...
add_clone(NPCS+"varios_mina_zhyrkhom.c",random(1));
add_clone(NPCS+"minero_mina_zhyrkhom.c",random(3));

add_exit("noroeste",ZHYRKHOM+"min76.c","standard");
add_exit("sudoeste",ZHYRKHOM+"min67.c","standard");
add_exit("sudeste",ZHYRKHOM+"min69.c","standard");
add_exit("este",ZHYRKHOM+"min71.c","standard");
