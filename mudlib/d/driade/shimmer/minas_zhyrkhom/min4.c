...
add_clone(NPCS+"npcs/varios_mina_zhyrkhom.c",random(2));
add_clone(NPCS+"minero_mina_zhyrkhom.c",random(1));

add_exit("norte",ZHYRKHOM+"min8.c","standard");
add_exit("noroeste",ZHYRKHOM+"min10.c","standard");
add_exit("sudoeste",ZHYRKHOM+"min3.c","standard");
add_exit("noreste",ZHYRKHOM+"min5.c","standard");
