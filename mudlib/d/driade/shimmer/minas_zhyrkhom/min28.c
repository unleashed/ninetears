...
add_exit("norte",ZHYRKHOM+"min31.c","standard");
add_exit("sur",ZHYRKHOM+"min16.c","standard");
add_exit("este",ZHYRKHOM+"min29.c","standard");
add_exit("oeste",ZHYRKHOM+"min30.c","standard");
