...
add_exit("noroeste",ZHYRKHOM+"min75.c","standard");
add_exit("noreste",ZHYRKHOM+"min73.c","standard");
add_exit("sur",ZHYRKHOM+"min71.c","standard");
add_exit("sudeste",ZHYRKHOM+"min70.c","standard");
