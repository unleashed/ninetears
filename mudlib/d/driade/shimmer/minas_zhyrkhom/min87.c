...
add_exit("norte",ZHYRKHOM+"min88.c","standard");
add_exit("oeste",ZHYRKHOM+"min93.c","standard");
add_exit("sudoeste",ZHYRKHOM+"min94.c","standard");
add_exit("sudeste",ZHYRKHOM+"min86.c","standard");
