...
add_exit("norte",ZHYRKHOM+"min34.c","standard");
add_exit("sur",ZHYRKHOM+"min28.c","standard");
add_exit("este",ZHYRKHOM+"min33.c","standard");
add_exit("oeste",ZHYRKHOM+"min32.c","standard");
