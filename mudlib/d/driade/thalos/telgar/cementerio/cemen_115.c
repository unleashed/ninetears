...
add_exit("oeste",CEMENTERIO+"cemen_114.c","standard");
add_exit("norte",CEMENTERIO+"cemen_99.c","standard");
add_exit("este",CEMENTERIO+"cemen_116.c","standard");
add_exit("sudeste",CEMENTERIO+"cemen_124.c","standard");
}
