...
add_exit("oeste",CEMENTERIO+"cemen_180.c","standard");
add_exit("norte",CEMENTERIO+"cemen_164.c","standard");
add_exit("noreste",CEMENTERIO+"cemen_165.c","standard");
add_exit("sur",CEMENTERIO+"cemen_187.c","standard");
}
