...
add_exit("oeste",CEMENTERIO+"cemen_149.c","standard");
add_exit("norte",CEMENTERIO+"cemen_132.c","standard");
add_exit("este",CEMENTERIO+"cemen_151.c","standard");
add_exit("sur",CEMENTERIO+"cemen_157.c","standard");
}
