...
add_exit("oeste",CEMENTERIO+"cemen_72.c","standard");
add_exit("norte",CEMENTERIO+"cemen_62.c","standard");
add_exit("este",CEMENTERIO+"cemen_74.c","standard");
add_exit("sur",CEMENTERIO+"cemen_87.c","standard");
}
