...
add_exit("oeste",CEMENTERIO+"cemen_112.c","standard");
add_exit("norte",CEMENTERIO+"cemen_98.c","standard");
add_exit("este",CEMENTERIO+"cemen_114.c","standard");
add_exit("sur",CEMENTERIO+"cemen_123.c","standard");
}
