...
add_exit("oeste",CEMENTERIO+"cemen_177.c","standard");
add_exit("norte",CEMENTERIO+"cemen_163.c","standard");
add_exit("este",CEMENTERIO+"cemen_179.c","standard");
add_exit("sur",CEMENTERIO+"cemen_186.c","standard");
}
