...
add_exit("oeste",CEMENTERIO+"cemen_174.c","standard");
add_exit("norte",CEMENTERIO+"cemen_162.c","standard");
add_exit("este",CEMENTERIO+"cemen_176.c","standard");
add_exit("sur",CEMENTERIO+"cemen_185.c","standard");
}
