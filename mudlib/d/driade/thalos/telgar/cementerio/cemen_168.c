...
add_exit("oeste",CEMENTERIO+"cemen_167.c","standard");
add_exit("norte",CEMENTERIO+"cemen_157.c","standard");
add_exit("este",CEMENTERIO+"cemen_169.c","standard");
add_exit("sudoeste",CEMENTERIO+"cemen_182.c","standard");
}
