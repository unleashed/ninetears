...
add_exit("oeste",CEMENTERIO+"cemen_35.c","standard");
add_exit("norte",CEMENTERIO+"cemen_27.c","standard");
add_exit("este",CEMENTERIO+"cemen_37.c","standard");
add_exit("sur",CEMENTERIO+"cemen_52.c","standard");
}
