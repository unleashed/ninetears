...
add_exit("oeste",CEMENTERIO+"cemen_142.c","standard");
add_exit("norte",CEMENTERIO+"cemen_130.c","standard");
add_exit("este",CEMENTERIO+"cemen_144.c","standard");
add_exit("sur",CEMENTERIO+"cemen_155.c","standard");
}
