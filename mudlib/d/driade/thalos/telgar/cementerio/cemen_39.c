...
add_exit("oeste",CEMENTERIO+"cemen_38.c","standard");
add_exit("norte",CEMENTERIO+"cemen_28.c","standard");
add_exit("este",CEMENTERIO+"cemen_40.c","standard");
add_exit("sur",CEMENTERIO+"cemen_53.c","standard");
}
