...
add_exit("oeste",CEMENTERIO+"cemen_136.c","standard");
add_exit("norte",CEMENTERIO+"cemen_127.c","standard");
add_exit("este",CEMENTERIO+"cemen_138.c","standard");
add_exit("sur",CEMENTERIO+"cemen_153.c","standard");
}
