...
add_exit("oeste",CEMENTERIO+"cemen_109.c","standard");
add_exit("norte",CEMENTERIO+"cemen_97.c","standard");
add_exit("este",CEMENTERIO+"cemen_111.c","standard");
add_exit("sur",CEMENTERIO+"cemen_122.c","standard");
}
