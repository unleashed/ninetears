...
add_exit("oeste",CEMENTERIO+"cemen_47.c","standard");
add_exit("norte",CEMENTERIO+"cemen_31.c","standard");
add_exit("este",CEMENTERIO+"cemen_49.c","standard");
add_exit("sudoeste",CEMENTERIO+"cemen_57.c","standard");
}
