...
add_exit("oeste",CEMENTERIO+"cemen_145.c","standard");
add_exit("norte",CEMENTERIO+"cemen_131.c","standard");
add_exit("este",CEMENTERIO+"cemen_147.c","standard");
add_exit("sur",CEMENTERIO+"cemen_156.c","standard");
}
