...
add_exit("oeste",CEMENTERIO+"cemen_80.c","standard");
add_exit("norte",CEMENTERIO+"cemen_65.c","standard");
add_exit("este",CEMENTERIO+"cemen_82.c","standard");
add_exit("sur",CEMENTERIO+"cemen_91.c","standard");
}
