...
add_exit("oeste",CEMENTERIO+"cemen_41.c","standard");
add_exit("norte",CEMENTERIO+"cemen_29.c","standard");
add_exit("este",CEMENTERIO+"cemen_43.c","standard");
add_exit("sur",CEMENTERIO+"cemen_54.c","standard");
}
