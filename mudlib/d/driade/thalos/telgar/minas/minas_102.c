...
add_exit("oeste",MINAS+"minas_101.c","standard");
add_exit("norte",MINAS+"minas_86.c","standard");
add_exit("este",MINAS+"minas_103.c","standard");
add_exit("sur",MINAS+"minas_132.c","standard");
}
