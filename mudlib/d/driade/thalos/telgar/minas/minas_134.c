...
add_exit("oeste",MINAS+"minas_133.c","standard");
add_exit("norte",MINAS+"minas_104.c","standard");
add_exit("este",MINAS+"minas_135.c","standard");
add_exit("sudeste",MINAS+"minas_149.c","standard");
}
