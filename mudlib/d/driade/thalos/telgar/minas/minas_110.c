...
add_exit("oeste",MINAS+"minas_109.c","standard");
add_exit("noroeste",MINAS+"minas_88.c","standard");
add_exit("este",MINAS+"minas_111.c","standard");
add_exit("sur",MINAS+"minas_140.c","standard");
}
