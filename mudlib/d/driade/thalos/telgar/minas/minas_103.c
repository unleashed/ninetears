...
add_exit("oeste",MINAS+"minas_102.c","standard");
add_exit("norte",MINAS+"minas_87.c","standard");
add_exit("este",MINAS+"minas_104.c","standard");
add_exit("sur",MINAS+"minas_133.c","standard");
}
