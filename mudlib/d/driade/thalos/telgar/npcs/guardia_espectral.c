...
void setup() {
	...
	ob1=clone_object("/d/driade/thalos/telgar/npcs/equipo/hacha_espectral");
	ob1->move(TP);
       	ob2=clone_object("/d/driade/thalos/telgar/npcs/equipo/armadura_espectral.c");
	ob2->move(TP);
	ob3=clone_object("/d/driade/thalos/telgar/npcs/equipo/yelmo_espectral.c");	
	ob3->move(TP);
	init_equip();
