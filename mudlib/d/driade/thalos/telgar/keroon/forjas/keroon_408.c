...
add_exit("oeste",FORJAS+"keroon_407.c","standard");
add_exit("norte",FORJAS+"keroon_388.c","standard");
add_exit("este",KEROONPOBRE+"keroon_409.c","standard");
add_exit("sur",FORJAS+"keroon_433.c","standard");
}
