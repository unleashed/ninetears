...
add_exit("oeste",FORJAS+"keroon_405.c","standard");
add_exit("norte",FORJAS+"keroon_386.c","standard");
add_exit("este",FORJAS+"keroon_407.c","standard");
add_exit("sur",FORJAS+"keroon_431.c","standard");
}
