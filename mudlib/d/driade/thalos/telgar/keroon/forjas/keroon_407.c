...
add_exit("oeste",FORJAS+"keroon_406.c","standard");
add_exit("norte",FORJAS+"keroon_387.c","standard");
add_exit("este",FORJAS+"keroon_408.c","standard");
add_exit("sur",FORJAS+"keroon_432.c","standard");
}
