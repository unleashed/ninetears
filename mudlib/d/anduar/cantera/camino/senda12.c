...
void setup()
{
   ...
   "guardianes que lo cuiden, a lo lejos al oeste observas como aparece una "
   "cantera, totalmente en desuso.");

   add_exit("northeast"   ,CANTERA"senda11.c","road");
   add_exit("oeste"   ,CANTERA"senda13.c","road");
   set_light(65);
   crea_bichos();
}
