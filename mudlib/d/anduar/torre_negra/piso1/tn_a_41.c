...
void setup() {
   ...
   "No sabes por cuanto tiempo podras aguantar esta sensacion de opresion en "
   "tu alma, cada paso que das parece que te lleve a una destruccion futura.\n");
   
   add_clone(TN"npcs/zombie",random(2-1));
   
   add_exit("norte",TN1"tn_a_42","road");
   add_exit("sur",TN1"tn_a_40","road");
   set_zone("tn");   
}
