...
void setup() {
   ...
   "Los zombies que te vas encontrando tienen un cierto parecido con los guardias "
   "que hay en Anduar, pero estan terriblemente deformados, piensas que "
   "seguramente fue el mismisimo Oskuro quien los convirtio en lo que son. \n");
   
   add_clone(TN"npcs/zombie",random(2-1));
   add_exit("norte",TN1"tn_a_15","road");
   add_exit("sur",TN1"tn_a_17","road");
   set_zone("tn");
}
