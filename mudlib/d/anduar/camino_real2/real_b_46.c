...
void setup()
{
   ...
   "al viajero del ardiente sol, al norte se observa un hermoso arbol.\n");
   add_exit("oeste",  "/d/dendara/rooms/camino/s14","road");
  add_exit("sur",    REAL2+"real_b_45","road");
   set_light(50);
   crea_bichos();
   add_clone("/d/dendara/items/arbol", 1);   
}
