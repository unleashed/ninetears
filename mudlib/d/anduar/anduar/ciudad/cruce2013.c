...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo.\n");
   add_exit("noroeste",ANDUAR"cruce1912.c","road");
   add_exit("norte"   ,ANDUAR"cruce1913.c","road");
   add_exit("noreste" ,ANDUAR"cruce1914.c","road");
   add_exit("sur"     ,ANDUAR"cc2113.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}
