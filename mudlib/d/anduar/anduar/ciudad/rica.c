...
void long_desc()
{
 ...
 "una verja con figuras en columnas"});
 string descripcion5;  
   ...
   for (i=0; i<n; i++)
   {
      ...
      switch (tipo)
      {
         ...
         case 1: add_clone(ANDUAR+"npcs/ciudadano", 1);
                 break;
         case 2: add_clone(ANDUAR+"npcs/pajaro", 1);
                 break;
         case 3: add_clone(ANDUAR+"npcs/perro", 1);
                 break;
         case 4: add_clone(ANDUAR+"npcs/gato", 1);
                 break;
         case 5: add_clone(ANDUAR+"npcs/caballo", 1);
                 break;
         case 6: add_clone(ANDUAR+"npcs/noble2", 1);
                 break;
         case 7: add_clone(ANDUAR+"npcs/ciudadana", 1);
                 break;
      }
   }
}
