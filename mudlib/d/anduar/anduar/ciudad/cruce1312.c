...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo.\n");
   add_exit("noreste" ,ANDUAR"cruce1213.c","road");
   add_exit("oeste"   ,ANDUAR"cg1311.c","road");
   add_exit("este"    ,ANDUAR"cruce1313.c","road");
   add_exit("sudeste" ,ANDUAR"cruce1413.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}
