...
void setup()
{
   set_short("%^YELLOW%^Exterior de Anduar: Puerta Este%^RESET%^");
   ...
   add_exit("norte"   ,ANDUAR"muralla0512.c","road");
add_exit("este", "/d/orgoth/areas/senda/rooms/caop01.c","road");
   add_exit("dentro"  ,ANDUAR"puerta1325.c","road");
