...
void setup()
{
   set_short("Oficina de correos de Anduar");
   set_long("Esta es la oficina de correos de Anduar. Es conocida por su "+
   ...
   set_light(85);
   add_exit("fuera", FUERA+"an0710", "door");
   add_exit("fuera", ANDUAR+"an0710", "door");
   add_exit("portal", "/room/entryroom", "door"); // new by Alex
