...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo.\n");
   add_exit("noroeste",ANDUAR"cruce0706.c","road");
   add_exit("norte"   ,ANDUAR"cruce0707.c","road");
   add_exit("noreste" ,ANDUAR"cruce0708.c","road");
   add_exit("sur"     ,ANDUAR"ao0907.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}