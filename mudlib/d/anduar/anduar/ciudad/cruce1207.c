...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo.\n");
   add_exit("norte"   ,ANDUAR"ao1107.c","road");
   add_exit("sudoeste",ANDUAR"cruce1306.c","road");
   add_exit("sur"     ,ANDUAR"cruce1307.c","road");
   add_exit("sudeste" ,ANDUAR"cruce1308.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}
