...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo.\n");
   add_exit("norte"   ,ANDUAR"ae1119.c","road");
   add_exit("sudoeste",ANDUAR"cruce1318.c","road");
   add_exit("sur"     ,ANDUAR"cruce1319.c","road");
   add_exit("sudeste" ,ANDUAR"cruce1320.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}