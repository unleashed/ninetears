...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo.\n");
   add_exit("noroeste",ANDUAR"cruce0613.c","road");
   add_exit("oeste"   ,ANDUAR"cruce0713.c","road");
   add_exit("este"    ,ANDUAR"an0715.c","road");
   add_exit("sudoeste",ANDUAR"cruce0813.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}