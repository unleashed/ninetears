...
void setup()
{
   ...
   add_exit("noroeste",ANDUAR"cruce0718.c","road");
   add_exit("norte"   ,ANDUAR"cruce0719.c","road");
   add_exit("noreste" ,ANDUAR"cruce0720.c","road");
   add_exit("sur"     ,ANDUAR"ae0919.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}