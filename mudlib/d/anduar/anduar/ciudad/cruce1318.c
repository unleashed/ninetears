...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo. Al oeste observas una reja que separa la zona rica de la ciudad "

        "de la demas.\n");
   add_exit("noreste" ,ANDUAR"cruce1219.c","road");
// add_exit("oeste"   ,ANDUAR"cg1317.c","road");
   add_exit("este"    ,ANDUAR"cruce1319.c","road");
   add_exit("sudeste" ,ANDUAR"cruce1419.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}
...
int abrir(string str)
{
 if (str == "verja")
  ...
  TP->move(load_object(ANDUAR+"cg1317.c"));
   this_player()->look_me();
