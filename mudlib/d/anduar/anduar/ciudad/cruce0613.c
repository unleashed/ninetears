...
void setup()
{
   ...
   add_exit("norte"   ,ANDUAR"cc0513.c","road");
   add_exit("sudoeste",ANDUAR"cruce0712.c","road");
   add_exit("sur"     ,ANDUAR"cruce0713.c","road");
   add_exit("sudeste" ,ANDUAR"cruce0714.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}