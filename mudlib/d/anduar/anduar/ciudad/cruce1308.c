...
void setup()
{
   ...
   set_long("Estas en una pequenya zona verde en la ancestral ciudad de "
        ...
        "elfo. Al este observas una reja que separa la zona rica de la ciudad "
        "de la demas.\n");
   add_exit("noroeste",ANDUAR"cruce1207.c","road");
   add_exit("oeste"   ,ANDUAR"cruce1307.c","road");
// add_exit("este"    ,ANDUAR"cg1309.c","road");
   add_exit("sudoeste",ANDUAR"cruce1407.c","road");
   base_desc();
   set_zone("Anduar");
   crea_bichos();
}
...
int abrir(string str)
{
 if (str == "verja")
  ...
  TP->move(load_object(ANDUAR+"cg1309.c"));
   this_player()->look_me();
