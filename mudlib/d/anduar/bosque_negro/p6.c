...
void setup()
{
   ...
   "dentro del mismo.\n");
   add_exit("norte",    BOSQUENEGRO+"p9", "plain");
   add_exit("noroeste", BOSQUENEGRO+"p8", "plain");
   add_exit("sur",      BOSQUENEGRO+"p3", "plain");
   add_exit("sudeste",  BOSQUENEGRO+"p4", "plain");
   add_exit("oeste",    BOSQUENEGRO+"p5", "plain");
   set_light(20);
