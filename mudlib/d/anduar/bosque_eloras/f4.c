...
void setup()
{
   ...
   add_exit("norte", BOSQUEELORAS+"f3", "plain");
   add_exit("sur", BOSQUEELORAS+"f5", "plain");
   add_exit("noreste", BOSQUEELORAS+"d8", "plain");
   add_exit("sudeste", BOSQUEELORAS+"e5", "plain");
  add_exit("oeste", BOSQUEELORAS+"h6", "plain");
set_light(50);
