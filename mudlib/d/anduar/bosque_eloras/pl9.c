...
void setup()
{
   ...
   add_exit("oeste", BOSQUEELORAS+"pl10", "plain");
   add_exit("este", BOSQUEELORAS+"pl8", "plain");
   add_exit("sudoeste", BOSQUEELORAS+"j1", "plain");
  add_exit("dentro", BOSQUEELORAS+"tienda", "plain");
set_light(50);
