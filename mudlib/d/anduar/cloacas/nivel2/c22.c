...
set_light(0);
add_exit(N ,NIVEL2+"c21","corridor");
add_exit(NE,NIVEL2+"c27","corridor");
add_exit(SE,NIVEL2+"c29","corridor");
add_exit(SO,NIVEL2+"c17","corridor");
add_exit(O ,NIVEL2+"c16","corridor");
