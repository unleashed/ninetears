...
set_light(0);
add_exit(N ,NIVEL2+"c05","corridor");
add_exit(NE,NIVEL2+"c11","corridor");
add_exit(E ,NIVEL2+"c12","corridor");
add_exit(SO,NIVEL2+"c31","corridor");
add_exit(O ,NIVEL2+"c36","corridor");
