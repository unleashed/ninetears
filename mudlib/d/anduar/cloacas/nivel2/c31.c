...
add_exit(NE,NIVEL2+"c06","corridor");
add_exit(E ,NIVEL2+"c01","corridor");
add_exit(S ,NIVEL2+"c32","corridor");
add_exit(SO,NIVEL2+"c26","corridor");
add_exit(O ,NIVEL2+"c25","corridor");
set_zone("nivel2");
