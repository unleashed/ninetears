...
add_exit(N ,NIVEL2+"c35","corridor");
add_exit(E ,NIVEL2+"c06","corridor");
add_exit(SE,NIVEL2+"c01","corridor");
add_exit(O ,NIVEL2+"c30","corridor");
add_exit(NO,NIVEL2+"c29","corridor");
set_zone("nivel2");
