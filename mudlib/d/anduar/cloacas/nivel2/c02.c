...
set_light(0);
add_exit(S ,NIVEL2+"c03","corridor");
add_exit(E ,NIVEL2+"c08","corridor");
add_exit(SO,NIVEL2+"c33","corridor");
add_exit(N ,NIVEL2+"c01","corridor");
add_exit(O ,NIVEL2+"c32","corridor");
