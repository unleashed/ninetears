...
void setup()
{
   ...
   "hace tan bajo que te obliga a ir arrastrandote por el suelo, desde luego "
   "parece ser tarde para volver atras. \n");
   ...
   add_exit("noreste", CLOACAS+"c33", "corridor");
