...
void setup()
{
   ...
   "arcadas y ganas de vomitar, por todos lados multitud de insectos se "
   "mueven, nadando entre las fangosas aguas.\n" 
   ...
   add_exit("southeast", CLOACAS+"c51", "corridor");
   add_exit("northwest",  CLOACAS+"c53", "corridor");
   set_light(20);
   crea_bichos();
}
