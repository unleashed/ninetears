...
add_exit("norte","/w/drakzten/bosque/room/bosque2","door");

add_exit("sur","/w/drakzten/bosque/room/bosque12","door");

add_exit("este","/w/drakzten/bosque/room/bosque6","door");

add_exit("oeste","/w/drakzten/bosque/room/bosque9","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque12","door");

add_exit("sudeste","/w/drakzten/bosque/room/bosque13","door");
