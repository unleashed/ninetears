...
add_exit("noreste","/w/drakzten/bosque/room/bosque29","door");

add_exit("sudeste","/w/drakzten/bosque/room/bosque31","door");

add_clone("/w/drakzten/bosque/npj/lobo",1);
add_clone("/w/drakzten/bosque/npj/aranya",1);
add_clone("/w/drakzten/bosque/npj/buho",4);
add_clone("/w/drakzten/bosque/npj/aventurero_tralak",2);  
         }