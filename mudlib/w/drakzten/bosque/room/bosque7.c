...
add_exit("oeste","/w/drakzten/bosque/room/bosque3","door");

add_exit("sudeste","/w/drakzten/bosque/room/bosque15","door");

add_exit("sur","/w/drakzten/bosque/room/bosque16","door");
