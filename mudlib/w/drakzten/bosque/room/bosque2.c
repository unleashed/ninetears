...
add_exit("norte","/w/drakzten/bosque/room/bosque1","door");

add_exit("sur","/w/drakzten/bosque/room/bosque5","door");

add_exit("este","/w/drakzten/bosque/room/bosque3","door");

add_exit("oeste","/w/drakzten/bosque/room/bosque4","door");
