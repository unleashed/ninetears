...
add_exit("norte","/w/drakzten/bosque/room/bosque3","door");

add_exit("sudeste","/w/drakzten/bosque/room/bosque14","door");

add_exit("este","/w/drakzten/bosque/room/bosque16","door");

add_exit("oeste","/w/drakzten/bosque/room/bosque5","door");
