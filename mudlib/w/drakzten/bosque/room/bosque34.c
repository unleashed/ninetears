...
add_exit("noreste","/w/drakzten/bosque/room/bosque21","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque37","door");

add_clone("/w/drakzten/bosque/npj/lobo",4);
add_clone("/w/drakzten/bosque/npj/aranya",4);
add_clone("/w/drakzten/bosque/npj/viajero_tralak",2);
