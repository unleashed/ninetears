...
add_exit("noreste","/w/drakzten/bosque/room/bosque24","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque26","door");

add_clone("/w/drakzten/bosque/npj/lobo",3);
add_clone("/w/drakzten/bosque/npj/aranya",1);
add_clone("/w/drakzten/bosque/npj/buho",2);
add_clone("/w/drakzten/bosque/npj/viajero_tralak",1);
