...
add_exit("sudoeste","/w/drakzten/bosque/room/bosque51","door");

add_exit("noreste","/w/drakzten/bosque/room/bosque53","door");

add_clone("/w/drakzten/bosque/npj/lobo",1);
add_clone("/w/drakzten/bosque/npj/aranya",1);
add_clone("/w/drakzten/bosque/npj/buho",1);
add_clone("/w/drakzten/bosque/npj/aventurero",2);
