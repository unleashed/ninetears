...
add_exit("noroeste","/w/drakzten/bosque/room/bosque1","door");

add_exit("sur","/w/drakzten/bosque/room/bosque6","door");

add_exit("este","/w/drakzten/bosque/room/bosque7","door");

add_exit("oeste","/w/drakzten/bosque/room/bosque2","door");

add_exit("sudeste","/w/drakzten/bosque/room/bosque16","door");
