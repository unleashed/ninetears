...
add_exit("noreste","/w/drakzten/bosque/room/bosque37","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque39","door");

add_clone("/w/drakzten/bosque/npj/lobo",4);
add_clone("/w/drakzten/bosque/npj/aranya",2);
add_clone("/w/drakzten/bosque/npj/viajera_tralak",2);
