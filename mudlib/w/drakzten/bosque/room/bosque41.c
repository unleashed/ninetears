...
add_exit("noroeste","/w/drakzten/bosque/room/bosque40","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque42","door");

add_clone("/w/drakzten/bosque/npj/lobo",2);
add_clone("/w/drakzten/bosque/npj/aranya",4);
add_clone("/w/drakzten/bosque/npj/aventurero_tralak",1);
