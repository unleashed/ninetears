...
add_exit("sur","/w/drakzten/bosque/room/bosque11","door");

add_exit("este","/w/drakzten/bosque/room/bosque4","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque20","door");
