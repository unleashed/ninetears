...
add_exit("norte","/w/drakzten/bosque/room/bosque7","door");

add_exit("oeste","/w/drakzten/bosque/room/bosque6","door");

add_exit("sudeste","/w/drakzten/bosque/room/bosque17","door");

add_exit("noroeste","/w/drakzten/bosque/room/bosque3","door");
