...
add_exit("norte","/w/drakzten/bosque/room/bosque10","door");

add_exit("noreste","/w/drakzten/bosque/room/bosque4","door");

add_exit("este","/w/drakzten/bosque/room/bosque9","door");

add_exit("sudoeste","/w/drakzten/bosque/room/bosque21","door");
