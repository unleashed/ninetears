...
set_long(query_short()+"\n Te encuentras en la gran cocina de "+capitalize(YO)+", puedes apreciar de la cocina esta muy limpia y muy ordenada casi perfecta. Al fondo puedes ver una mesa y a su lado una silla. La cocina tiene una pequeña ventana la cual tiene vista al mar. En la pared puedes ver una nota pegada con un clavo.\n\n");
...
add_exit("fuera","/w/drakzten/workroom","door");

add_exit("oeste","/w/drakzten/baño","door");

add_exit("sur","/w/drakzten/pasillo","door");
