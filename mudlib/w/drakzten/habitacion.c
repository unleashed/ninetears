...
set_long(query_short()+"\n Es una gran habitacion, al entrar sientes inmediatamente una relajacion espiritual, al fondo puedes oir una radio que suena muy agradable, en el medio una gran cama la cual te transporta inmediatamente al mundo de los sueños, en una pared puedes ver un cuadro.\n\n");
...
add_exit("norte","/w/drakzten/pasillo","door");
...
int move_desk(string str) {
	if(str == "cuadro") {
		...
		add_exit("escaleras","/w/drakzten/sotano.c","door");
