...
void setup()
{
  ...
  set_long("%^BOLD%^%^YELLOW%^M%^RESET%^%^ORANGE%^ercado %^RESET%^de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Tienda\n\n"
           "Esta es la tienda de telas y ropa de Asgard. Aqui los nobles compran sus finos trajes y los "
           "ajuares para su hogar. Tambien hay una seccion con ropa menos trabajada para los ciudadanos "
