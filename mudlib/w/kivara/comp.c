...
void setup()
{
  ...
  set_long("%^BOLD%^%^YELLOW%^M%^RESET%^%^ORANGE%^ercado %^RESET%^de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Tienda\n\n"
           "Esta es la tienda de joyas y complementos de Asgard. Aqui los nobles compran sus accesorios y los "
           "objetos decorativos para su hogar. Tambien hay una seccion con baratijas para los ciudadanos "
