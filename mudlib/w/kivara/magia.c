...
void setup()
{
  ...
  set_long("%^BOLD%^%^YELLOW%^M%^RESET%^%^ORANGE%^ercado %^RESET%^de %^BOLD%^%^BLACK%^Asgard%^RESET%^: Tienda\n\n"
           "Esta es la tienda de magia y objetos raros de Asgard. Aqui los aprendices compran los ingredientes "
           "para sus pociones. Tambien se puede encontrar gran variedad de objetos extranyos que no sabes muy "
           "bien para que podrian servir.\n\n"  
           "Los comandos son:\n\n"
