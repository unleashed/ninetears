...
set_light(45);
add_clone("/w/monhal/npc/escarabajo.c",3);
add_clone("/w/monhal/npc/vaca.c",2);
add_exit("norte","/w/monhal/camino/camino2.c","road");
add_exit("sur","/w/monhal/camino/camino4.c","road"); 
}