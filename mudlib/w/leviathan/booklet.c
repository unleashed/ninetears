...
void setup()
{
    ...
    set_short("manual");
    add_alias("manual");
    set_long("Esto es un manual de uso para aquellas personas que entran por primera vez al juego, "+
      "que sirva de oriencacion en los comandos basicos del mismo.\n "+
