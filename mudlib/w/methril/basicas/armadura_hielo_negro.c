// Vilat 29.10.2002 - Armadura avanzada
// Esta es muy sencilla pero lo vais a flipar :) Siempre habia querido hacerme esta armadura
...
int do_maniobra() {
	...
	if (TP->query_cap_name()!="Vilat") return notify_fail("Solo Vilat, Senyor del Inframundo, puede hacer la fantastica maniobra de la muerte.\n");
