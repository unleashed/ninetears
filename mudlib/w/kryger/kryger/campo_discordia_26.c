...
"puede dar fe de ello.\n\n");
	...
	add_exit("noreste",ROOMRING"campo_discordia_31.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_19.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_30.c","standard");
	add_exit("noroeste",ROOMRING"campo_discordia_21.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_20.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_25.c","standard");
}