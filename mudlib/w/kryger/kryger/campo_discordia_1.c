...
"puede dar fe de ello.\n\n");
	...
	add_exit("norte",ROOMRING"campo_discordia_2.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_6.c","standard");
	add_exit("este",ROOMRING"campo_discordia_7.c","standard");
}