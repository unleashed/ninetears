...
"puede dar fe de ello.\n\n");
	...
	add_exit("noreste",ROOMRING"campo_discordia_14.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_12.c","standard");
	add_exit("este",ROOMRING"campo_discordia_13.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_3.c","standard");
}