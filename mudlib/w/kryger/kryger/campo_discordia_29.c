...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_33.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_28.c","standard");
	add_exit("noroeste",ROOMRING"campo_discordia_24.c","standard");
}