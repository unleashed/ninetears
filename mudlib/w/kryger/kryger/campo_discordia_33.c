...
"puede dar fe de ello.\n\n");
	...
	add_exit("norte",ROOMRING"campo_discordia_34.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_28.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_29.c","standard");
}