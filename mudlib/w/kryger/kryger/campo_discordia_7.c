...
"puede dar fe de ello.\n\n");
	...
	add_exit("oeste",ROOMRING"campo_discordia_1.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_6.c","standard");
	add_exit("noreste",ROOMRING"campo_discordia_12.c","standard");
}