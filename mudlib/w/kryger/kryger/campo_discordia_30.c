...
"puede dar fe de ello.\n\n");
	...
	add_exit("noroeste",ROOMRING"campo_discordia_26.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_24.c","standard");
	add_exit("este",ROOMRING"campo_discordia_35.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_25.c","standard");
}