...
"puede dar fe de ello.\n\n");
	...
	add_exit("noreste",ROOMRING"campo_discordia_19.c","standard");
	add_exit("sudoeste",ROOMRING"campo_discordia_7.c","standard");
	add_exit("sudeste",ROOMRING"campo_discordia_17.c","standard");
	add_exit("noroeste",ROOMRING"campo_discordia_8.c","standard");
	add_exit("este",ROOMRING"campo_discordia_18.c","standard");
	add_exit("norte",ROOMRING"campo_discordia_13.c","standard");
}