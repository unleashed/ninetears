...
"puede dar fe de ello.\n\n");
	...
	add_exit("noreste",ROOMRING"campo_discordia_10.c","standard");
	add_exit("sur",ROOMRING"campo_discordia_4.c","standard");
	add_exit("este",ROOMRING"campo_discordia_9.c","standard");
}