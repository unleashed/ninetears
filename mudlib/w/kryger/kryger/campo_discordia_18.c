...
"puede dar fe de ello.\n\n");
	...
	add_exit("este",ROOMRING"campo_discordia_24.c","standard");
	add_exit("oeste",ROOMRING"campo_discordia_12.c","standard");
	add_exit("norte",ROOMRING"campo_discordia_19.c","standard");
}