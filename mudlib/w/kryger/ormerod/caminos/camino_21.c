...
void setup ()
{
	...
	"verdes.\n");
	set_light(100);
	add_exit("sudoeste","/w/kryger/ormerod/caminos/camino_19.c","door");
	add_exit("sudeste","/w/kryger/ormerod/caminos/camino_24.c","door");
	add_exit("sur","/w/kryger/ormerod/pastos/pasto_128.c","door");
}