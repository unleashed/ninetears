...
void setup ()
{
	...
	"verdes.\n");
	set_light(100);
	add_exit("oeste","/w/kryger/ormerod/caminos/camino_25.c","door");
	add_exit("este","/w/kryger/ormerod/corrales/corral_18.c","door");
	add_exit("sudeste","/w/kryger/ormerod/corrales/corral_17.c","door");
	add_exit("sur","/w/kryger/ormerod/corrales/corral_14.c","door");
}