...
void setup ()
{
	...
	"verdes.\n");
	set_light(100);
	add_exit("oeste","/w/kryger/ormerod/caminos/camino_16.c","door");
	add_exit("sudoeste","/w/kryger/ormerod/caminos/camino_15.c","door");
	add_exit("noreste","/w/kryger/ormerod/corrales/corral_13.c","door");
}