...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 12 %^RESET%^");
	...
	add_exit("norte","/w/kryger/clan/baulm11.c","standard");
	add_exit("sudoeste","/w/kryger/clan/baul4.c","standard");
}