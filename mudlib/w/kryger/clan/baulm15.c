...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 15 %^RESET%^");
	...
	add_exit("noroeste","/w/kryger/clan/baulm1.c","standard");
	add_exit("este","/w/kryger/clan/baulm14.c","standard");
}