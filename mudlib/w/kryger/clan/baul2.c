...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Caja Fuerte %^RESET%^");
	...
	add_exit("este","/w/kryger/clan/baul1.c","standard");
	add_exit("oeste","/w/kryger/clan/baulm1.c","secret");
}