...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 14 %^RESET%^");
	...
	add_exit("noreste","/w/kryger/clan/baul3.c","secret");
	add_exit("sur","/w/kryger/clan/baulm13.c","standard");
	add_exit("oeste","/w/kryger/clan/baulm15.c","standard");
}