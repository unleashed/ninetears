...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Tienda %^RESET%^");
	...
	add_exit("noroeste","/w/kryger/clan/animacion.c","standard");
	add_exit("este","/w/kryger/clan/taberna.c","standard");
	add_exit("sudoeste","/w/kryger/clan/tesoreria.c","standard");
}