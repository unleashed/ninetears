...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Sala de Resurrección %^RESET%^");
	...
	add_exit("sur","/w/kryger/clan/animacion.c","standard");
	add_exit("norte","/w/kryger/clan/baulm5.c","secret");
}