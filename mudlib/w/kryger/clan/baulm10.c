...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 10 %^RESET%^");
	...
	add_exit("noreste","/w/kryger/clan/baulm9.c","standard");
	add_exit("oeste","/w/kryger/clan/baulm11.c","standard");
}