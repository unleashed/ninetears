...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 1 %^RESET%^");
	...
	add_exit("este","/w/kryger/clan/baul2.c","secret");
	add_exit("noreste","/w/kryger/clan/baulm2.c","standard");
	add_exit("sudeste","/w/kryger/clan/baulm15.c","standard");
}