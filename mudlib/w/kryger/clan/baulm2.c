...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 2 %^RESET%^");
	...
	add_exit("este","/w/kryger/clan/baulm3.c","standard");
	add_exit("sudoeste","/w/kryger/clan/baulm1.c","standard");
}