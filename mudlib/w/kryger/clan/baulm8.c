...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 8 %^RESET%^");
	...
	add_exit("oeste","/w/kryger/clan/baulm7.c","standard");
	add_exit("sudeste","/w/kryger/clan/baulm9.c","standard");
}