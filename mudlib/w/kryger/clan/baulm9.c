...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 9 %^RESET%^");
	...
	add_exit("oeste","/w/kryger/clan/taberna.c","secret");
	add_exit("noroeste","/w/kryger/clan/baulm8.c","standard");
	add_exit("sudoeste","/w/kryger/clan/baulm10.c","standard");
}