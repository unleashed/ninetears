...
void setup()
{
	set_short("%^BOLD%^RED%^Age of %^BLACK%^Darkness: %^RESET%^RED%^Baul 13 %^RESET%^");
	...
	add_exit("norte","/w/kryger/clan/baulm14.c","standard");
	add_exit("sudeste","/w/kryger/clan/baul4.c","standard");
}