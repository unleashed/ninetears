...
void setup ()  
{
	...
	set_name("Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^");
	set_short("Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^");
	add_alias("espada");
	add_alias("deathbringer");
	add_adjective("aire");
	add_plural("espadas deathbringers");
	add_plural("espadas");
	add_plural("deathbringers");
	set_main_plural("Espadas %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^");
	set_weight(200);
	set_twohanded(0);
	set_long(
		"Ante ti tienes una magnifica espada deathbringer, su origen parece ser magico, muy ligera "
...
void write_message(string happen,int dam,string str,object me,object him) 
{
	  ...
	  tell_room(ENV(me),me->query_cap_name()+" roza con la "
		"Espada de %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^ a "
		+him->query_cap_name()+".\n"
		,({him,me}));
	  write("Rozas a "+him->query_cap_name()+" con tu "
		"Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^.\n");
	  ...
	  tell_room(ENV(me),me->query_cap_name()+" corta con la "
		"Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^ a "
	  ...
	  tell_room(ENV(me),me->query_cap_name()+" de un rapido movimiento "
		"con su Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^"
	  ...
	  write("De un rapido movimiento con tu "
	  	"Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^alcanzas a "
	  	+him->query_cap_name()+
	  ...
	  write("Trazas un gran arco en el %^BOLD%^aire con tu "
	  	"Espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^sobre "
	  	+him->query_cap_name()+
...
//defdr->set_hp(a-b);
	write("La espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^ brilla de placer "
	"con una luz %^BOLD%^CYAN%^azulada%^RESET%^, cuando se cobra su dosis de energia.\n");
	tell_object(defdr, "La espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^ de "+atckr->QCN+" brilla de placer con una luz %^BOLD%^CYAN%^azulada%^RESET%^ cuando te cobra su dosis de energia.\n");
	tell_room(ENV(atckr), "La espada %^RED%^Dea%^BOLD%^th%^YELLOW%^Br%^RED%^in%^RESET%^RED%^ger%^RESET%^ de "+atckr->QCN+" emite una luz %^BOLD%^CYAN%^azulada%^RESET%^ al impactar en "+defdr->QCN+".\n",({atckr,defdr}));
