...
void setup() {
  ...
  set_long("\n   Reinado Duergar:  Zona Aprendices.\n\n"
	 ...
	 "de aspecto suave y fino.  Los unicos objetos en el cuarto son unas pocas "
  ...
  add_item("muros",
	 ...
	 "paredes tan gruesas para llegar probablemente a otro cuarto "
	 "igual de aburrido que este.\n");
  ...
  add_exit("noroeste",NEWBIE+"dlev1_02","path");
  add_exit("sudoeste",NEWBIE+"dlev1_04","path");
  add_exit("este",NEWBIE+"dlev1_00","door");
  add_exit("oeste",NEWBIE+"dlev1_03","path");
