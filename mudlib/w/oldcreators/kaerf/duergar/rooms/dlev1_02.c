...
add_exit("sudeste",NEWBIE+"dlev1_01","path");
add_exit("sur",NEWBIE+"dlev1_03","path");
   ...
   if(pick <= 10)
     {
      write("   Aqui aun no puedes picar,debes ganar un poco de experiencia "
    	    "picando antes en otro cuarto. Prueba al sudeste.\n"
	    "\n");
   ...
   if(pick <= 12) 
      ...
      if(pick <= 20) 
	{
	 ...
	 return 1;
      ...
      if(pick <=100)
        {
	 write("   Al picar se ha levantado polvareda y no ves bien, "
