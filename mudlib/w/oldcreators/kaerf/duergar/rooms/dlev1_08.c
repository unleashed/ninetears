...
void setup() {
  ...
  set_long("\n   Reinado Duergar:  Zona Aprendices.\n\n"
	 ...
	 "         El muro al Este aparece lleno de lo que parecen "
  ...
  add_item("muros",
	 ...
	 "aburrido que este. No obstante al Este parece mas fragil.\n");
...
add_exit("noreste",NEWBIE+"dlev1_10","path");
//add_exit("este",NEWBIE+"dlev1_05","door");
add_exit("sur",NEWBIE+"dlev1_07","path");
...
int pickstuff(string arg) {
   ...
   if((arg == "roca") || (arg == "rocas") || (arg == "piedro") || 
      (arg == "piedras") || (arg == "suelo") || (arg == "piedra") || 
      (arg == "piedros")) 
     {
