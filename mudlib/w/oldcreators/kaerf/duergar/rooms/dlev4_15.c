...
void setup() {
  ...
  set_short("Reinado Duergar:  Simulacion de Submundos");
   ...
   add_exit("norte",NEWBIE+"dlev4_05","path");
   add_exit("sur",NEWBIE+"dlev4_20","path");
   add_exit("este",NEWBIE+"dlev4_16","path");
   add_exit("oeste",NEWBIE+"dlev4_14","path");
   add_exit("noreste",NEWBIE+"dlev4_11","path");
}
