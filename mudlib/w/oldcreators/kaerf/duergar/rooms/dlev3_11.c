...
add_exit("norte",NEWBIE+"dlev3_09","path");
add_exit("sur",NEWBIE+"dlev3_14","path");
add_exit("este",NEWBIE+"dlev3_05","path");
add_exit("oeste",NEWBIE+"dlev3_10","path");
add_exit("sudeste",NEWBIE+"dlev3_15","path");
}
