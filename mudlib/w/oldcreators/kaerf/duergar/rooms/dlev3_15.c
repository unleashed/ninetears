...
set_long("\n   Reinado Duergar:  Simulacion de Superficie.\n\n"
	 ...
	 "puedes ver el debil contorno del cuerto.  Esta ilusion "
...
add_exit("norte",NEWBIE+"dlev3_05","path");
add_exit("sur",NEWBIE+"dlev3_20","path");
add_exit("este",NEWBIE+"dlev3_16","path");
add_exit("oeste",NEWBIE+"dlev3_14","path");
add_exit("noroeste",NEWBIE+"dlev3_11","path");
}
