...
void setup() {
   ...
   add_exit("sur", NEWBIE+"dlev4_10", "path");
   add_exit("este",NEWBIE+"dlev4_04","path");
   add_exit("noreste",NEWBIE+"dlev4_03","path");
   add_exit("noroeste",NEWBIE+"dlev4_02","path");
   add_exit("sudeste",NEWBIE+"dlev4_05","path");
   add_exit("sudoeste",NEWBIE+"dlev4_00","door");
}
