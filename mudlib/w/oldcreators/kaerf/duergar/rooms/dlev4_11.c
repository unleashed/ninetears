...
void setup() {
   ...
   add_exit("norte",NEWBIE+"dlev4_08","path");
   add_exit("sur",NEWBIE+"dlev4_16","path");
   add_exit("este",NEWBIE+"dlev4_12","path");
   add_exit("oeste",NEWBIE+"dlev4_05","path");
   add_exit("sudoeste",NEWBIE+"dlev4_15","path");
}
