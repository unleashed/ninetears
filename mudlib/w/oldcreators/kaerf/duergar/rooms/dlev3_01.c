...
add_exit("sur", NEWBIE+"dlev3_12", "path");
add_exit("oeste",NEWBIE+"dlev3_04","path");
add_exit("noreste",NEWBIE+"dlev3_02","path");
add_exit("noroeste",NEWBIE+"dlev3_03","path");
add_exit("sudeste",NEWBIE+"dlev3_00","door");
add_exit("sudoeste",NEWBIE+"dlev3_05","path");
}
