...
add_exit("sur" ,CULTIVOS+"cultivo_30.c","standard");
add_exit("sudoeste" ,CULTIVOS+"cultivo_44.c","standard");
add_exit("noreste" ,CULTIVOS+"cultivo_33.c","standard");
add_exit("norte" ,CULTIVOS+"cultivo_xx.c","standard");
}