...
add_exit("oeste" ,CULTIVOS+"cultivo_3.c","standard");
add_exit("sur" ,CULTIVOS+"cultivo_1.c","standard");
add_exit("este",CULTIVOS+"cultivo_9.c","standard");
add_exit("sudeste",CULTIVOS+"cultivo_102.c","standard");
