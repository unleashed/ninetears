...
set_long("\n%^BOLD%^%^BLUE%^Cultivos humedos%^RESET%^.\n\nCada paso que das hacia el interior de estos cultivos te resulta mas dificil ver. Aqui la iluminacion es practicamente nula, no comprendes como los agricultores y agricultoras que trabajan aqui, pueden ver los productos que recolectan. Puedes ver unas especies de caretillas. Te llama la atencion una pequenya flor al lado de una de las carretilla. El aire aqui es frio y no invita a quedarse por mucho tiempo.\n\n");
...
add_item("flor","Ves una rara flor de colores muy vivos y lustrosos. Crees que podrias cogerla.\n");
add_clone("/w/vulvac/npcs/agricultor.c",random(3));
add_clone("/w/vulvac/npcs/agricultora.c",random(2));
add_exit("norte" ,CULTIVOS+"cultivo_30.c","standard");
add_exit("sudoeste" ,CULTIVOS+"cultivo_27.c","standard");
