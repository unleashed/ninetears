...
set_long("\n%^ORANGE%^Caseta de recoleccion%^RESET%^.\n\nEsta caseta es la tipica casita que se usa de almacen en los cultivos. Ves que el suelo esta sucio y lleno de sacos de liquenes y hongos. Puedes ver como un guardia vigila atentamente los sacos de viveres. Empiezas a deducir que esta es una de las pocas fuentes de alimentos que tiene la grann ciudad de Keroon.\n\n");
add_item("saco","Hay unos cuantos sacos de viveres empotrados contra la pared. Para ti no te resultan grann cosa pero parece ser que por esta zona son un bien muy preciado.\n");

add_exit("sur" ,CULTIVOS+"cultivo_14.c","standard");
