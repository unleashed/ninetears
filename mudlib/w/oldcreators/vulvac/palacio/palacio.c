...
set_long("\n%^BOLD%^Palacio Real%^RESET%^.\n\nEstas en una de las numerosas salas de este famoso castillo. Este castillo fue construido hace muchos anyos para honrar a uno de los mas poderosos y sabio Reyes Duergars, el Rey Ramthor. Ves muchas antorchas colgadas de las paredes que iluminan fuertemente el pasillo. Al largo de todo este pasillo ves armaduras colgadas de la pared en forma de decoracion, se dice que esta es una de las colecciones mas pequenyas del reino. Puedes ver como el castillo es simple de cuatro plantas.\n\n");
...
add_exit("norte" ,CULTIVOS+"palacio_61.c","standard");
add_exit("sur" ,CULTIVOS+"palacio_4.c","standard");
}