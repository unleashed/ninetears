...
add_clone("/w/huascar/bosquemalditio/npc/culebra.c",1);
add_clone("/w/huascar/bosquemaldito/npc/sanguijuela.c",1);
add_exit("sur","/w/bwamba/camino_playa/rooms/CP06.c","road"); 
add_exit("noreste","/w/bwamba/camino_playa/rooms/CP08.c","road");
}