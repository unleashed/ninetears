...
add_clone("/w/huascar/bosquemaldito/npc/culebra.c",5);
add_exit("oeste","/w/bwamba/camino_playa/rooms/CP04.c","road"); 
add_exit("norte","/w/bwamba/camino_playa/rooms/CP06.c","road");
}