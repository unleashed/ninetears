...
add_clone("/w/huascar/bosquemaldito/npc/sanguijuela.c",3);
add_exit("sur","/w/bwamba/camino_playa/rooms/CP09.c","road"); 
add_exit("norte","/w/bwamba/camino_playa/rooms/CP11.c","road");
}