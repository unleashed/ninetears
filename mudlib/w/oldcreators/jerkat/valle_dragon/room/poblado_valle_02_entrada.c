...
{
do_desc(1);
add_exit("sur","w/jerkat/valle_dragon/room/poblado_valle_05","road");
add_exit("oeste","w/jerkat/valle_dragon/room/poblado_valle_01","road");
...
int hacer(string str)
{
 if (str == "senyal")
 {
  ...
  add_exit("fuera","w/jerkat/valle_dragon/room/valle_18","door");
  renew_exits();
  return 1;
  }
 else
