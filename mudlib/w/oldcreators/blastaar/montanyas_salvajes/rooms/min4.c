...
"aqui se encuentran.\n\n");
set_light(30);
add_exit("norte","/w/blastaar/montanyas_salvajes/rooms/min2.c","door");
add_exit("oeste","/w/blastaar/montanyas_salvajes/rooms/min1.c","door");
add_exit("sur","/w/blastaar/montanyas_salvajes/rooms/min6.c","door");
}
