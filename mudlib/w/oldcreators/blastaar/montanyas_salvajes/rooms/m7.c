...
set_light(30);
add_exit("oeste","/w/blastaar/montanyas_salvajes/rooms/m5.c","door");
add_exit("este","/w/blastaar/montanyas_salvajes/rooms/m9.c","door");
add_exit("norte","/w/blastaar/montanyas_salvajes/rooms/m10.c","door");
add_exit("noreste","/w/blastaar/montanyas_salvajes/rooms/m11.c","door");
}
