...
"aqui se encuentran.\n\n");
set_light(30);
add_exit("norte","/w/blastaar/montanyas_salvajes/rooms/m8.c","door");
add_exit("este","/w/blastaar/montanyas_salvajes/rooms/min4.c","door");
add_exit("oeste","/w/blastaar/montanyas_salvajes/rooms/min5.c","door");
}
