...
add_exit("este",CHA"M0509.c","road");
add_exit("sudeste",CHA"M0409.c","road");
add_exit("sur",CHA"M0408.c","road");
add_exit("sudoeste",CHA"M0407.c","road");
add_exit("oeste",CHA"M0507.c","road");
add_exit("norte",CHA"M0608.c","road");
}