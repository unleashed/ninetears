...
add_exit("oeste",CHA"M0304.c","road");
add_exit("norte",CHA"M0405.c","road");
add_exit("noreste",CHA"M0406.c","road");
add_exit("este",CHA"M0306.c","road");
add_exit("sudeste",CHA"M0206.c","road");
}