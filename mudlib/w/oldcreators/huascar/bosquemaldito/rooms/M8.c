...
add_exit("norte",CHA"M11.c","road");
add_exit("noreste",CHA"M13.c","road");
add_exit("este",CHA"M14.c","road");
add_exit("sudeste",CHA"M1022.c","road");
add_exit("sur",CHA"M15.c","road");
add_exit("sudoeste",CHA"M16.c","road");
add_exit("oeste",CHA"M17.c","road");
add_exit("noroeste",CHA"M18.c","road");
}