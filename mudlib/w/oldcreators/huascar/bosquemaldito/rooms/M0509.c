...
add_exit("este",CHA"M0510.c","road");
add_exit("sudeste",CHA"M0410.c","road");
add_exit("sur",CHA"M0409.c","road");
add_exit("sudoeste",CHA"M0408.c","road");
add_exit("oeste",CHA"M0508.c","road");
}