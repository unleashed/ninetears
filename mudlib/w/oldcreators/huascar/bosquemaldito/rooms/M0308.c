...
add_exit("oeste",CHA"M0307.c","road");
add_exit("noroeste",CHA"M0407.c","road");
add_exit("norte",CHA"M0408.c","road");
add_exit("noreste",CHA"M0409.c","road");
add_exit("este",CHA"M0309.c","road");
add_exit("sudeste",CHA"M0209.c","road");
add_exit("sur",CHA"M0208.c","road");
add_exit("sudoeste",CHA"M0207.c","road");
}