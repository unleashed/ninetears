...
add_exit("noroeste",CHA"M0509.c","road");
add_exit("norte",CHA"M0510.c","road");
add_exit("este",CHA"M0411.c","road");
add_exit("sudeste",CHA"M0311.c","road");
add_exit("sur",CHA"M0310.c","road");
add_exit("sudoeste",CHA"M0309.c","road");
add_exit("oeste",CHA"M0409.c","road");
}