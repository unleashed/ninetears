...
add_exit("oeste",CHA"M0208.c","road");
add_exit("noroeste",CHA"M0308.c","road");
add_exit("norte",CHA"M0309.c","road");
add_exit("noreste",CHA"M0310.c","road");
add_exit("este",CHA"M0210.c","road");
}