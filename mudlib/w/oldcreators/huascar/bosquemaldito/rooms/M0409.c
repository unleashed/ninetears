...
add_exit("noroeste",CHA"M0508.c","road");
add_exit("norte",CHA"M0509.c","road");
add_exit("noreste",CHA"M0510.c","road");
add_exit("este",CHA"M0410.c","road");
add_exit("sudeste",CHA"M0310.c","road");
add_exit("sur",CHA"M0309.c","road");
add_exit("sudoeste",CHA"M0308.c","road");
add_exit("oeste",CHA"M0408.c","road");
}