...
add_exit("noroeste",CHA"M0507.c","road");
add_exit("norte",CHA"M0508.c","road");
add_exit("noreste",CHA"M0509.c","road");
add_exit("este",CHA"M0409.c","road");
add_exit("sudeste",CHA"M0309.c","road");
add_exit("sur",CHA"M0308.c","road");
add_exit("sudoeste",CHA"M0307.c","road");
add_exit("oeste",CHA"M0407.c","road");
}