...
add_exit("norte",CHA"M19.c","road");
add_exit("noreste",CHA"M20.c","road");
add_exit("este",CHA"M1.c","road");
add_exit("sudeste",CHA"M2.c","road");
add_exit("sur",CHA"M3.c","road");
add_exit("sudoeste",CHA"M4.c","road");
add_exit("oeste",CHA"M5.c","road");
add_exit("noroeste",CHA"M6.c","road");
}