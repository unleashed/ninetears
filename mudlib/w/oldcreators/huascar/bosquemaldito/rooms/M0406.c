...
add_exit("norte",CHA"M0506.c","road");
add_exit("noreste",CHA"M0507.c","road");
add_exit("este",CHA"M0407.c","road");
add_exit("sudeste",CHA"M0307.c","road");
add_exit("sur",CHA"M0306.c","road");
add_exit("sudoeste",CHA"M0305.c","road");
add_exit("oeste",CHA"M0405.c","road");
}