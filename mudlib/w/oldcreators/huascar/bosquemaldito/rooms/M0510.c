...
add_exit("sudeste",CHA"M0411.c","road");
add_exit("sur",CHA"M0410.c","road");
add_exit("sudoeste",CHA"M0409.c","road");
add_exit("oeste",CHA"M0509.c","road");
add_exit("noreste",CHA"M0611.c","road");
}