...
add_exit("oeste",CHA"M0309.c","road");
add_exit("noroeste",CHA"M0409.c","road");
add_exit("norte",CHA"M0410.c","road");
add_exit("noreste",CHA"M0411.c","road");
add_exit("este",CHA"M0311.c","road");
add_exit("sur",CHA"M0210.c","road");
add_exit("sudoeste",CHA"M0209.c","road");
}