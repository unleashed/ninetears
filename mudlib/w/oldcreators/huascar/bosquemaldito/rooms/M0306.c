...
add_exit("oeste",CHA"M0305.c","road");
add_exit("noroeste",CHA"M0405.c","road");
add_exit("norte",CHA"M0406.c","road");
add_exit("noreste",CHA"M0407.c","road");
add_exit("este",CHA"M0307.c","road");
add_exit("sudeste",CHA"M0207.c","road");
add_exit("sur",CHA"M0206.c","road");
}