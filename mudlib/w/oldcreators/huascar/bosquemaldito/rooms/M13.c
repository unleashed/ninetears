...
add_exit("norte",CHA"M9.c","road");
add_exit("noreste",CHA"M10.c","road");
add_exit("este",CHA"M11.c","road");
add_exit("sudeste",CHA"M12.c","road");
add_exit("sur",CHA"M0912.c","road");
add_exit("sudoeste",CHA"M13.c","road");
add_exit("oeste",CHA"M7.c","road");
