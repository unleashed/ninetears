...
add_exit("este",CHA"M0508.c","road");
add_exit("sudeste",CHA"M0408.c","road");
add_exit("sur",CHA"M0407.c","road");
add_exit("sudoeste",CHA"M0406.c","road");
add_exit("oeste",CHA"M0506.c","road");
}