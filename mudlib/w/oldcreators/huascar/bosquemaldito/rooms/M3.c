...
add_exit("norte",CHA"M1.c","road");
add_exit("noreste",CHA"M9.c","road");
add_exit("este",CHA"M11.c","road");
add_exit("sudeste",CHA"M13.c","road");
add_exit("sur",CHA"M16.c","road");
add_exit("sudoeste",CHA"M18.c","road");
add_exit("oeste",CHA"M19.c","road");
add_exit("noroeste",CHA"M4.c","road");
}