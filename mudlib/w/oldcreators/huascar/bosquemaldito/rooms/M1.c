...
add_exit("noreste",CHA"M5.c","road");
add_exit("este",CHA"M7.c","road");
add_exit("sudeste",CHA"M8.c","road");
add_exit("sur",CHA"M12.c","road");
add_exit("sudoeste",CHA"M15.c","road");
add_exit("oeste",CHA"M2.c","road");
