...
add_exit("oeste",CHA"M0207.c","road");
add_exit("noroeste",CHA"M0307.c","road");
add_exit("norte",CHA"M0308.c","road");
add_exit("noreste",CHA"M0309.c","road");
add_exit("este",CHA"M0209.c","road");
}