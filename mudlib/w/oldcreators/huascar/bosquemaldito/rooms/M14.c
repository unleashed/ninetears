...
add_exit("norte",CHA"M16.c","road");
add_exit("noreste",CHA"M17.c","road");
add_exit("este",CHA"M18.c","road");
add_exit("sudeste",CHA"M19.c","road");
add_exit("sur",CHA"M20.c","road");
add_exit("sudoeste",CHA"M1.c","road");
add_exit("oeste",CHA"M1212.c","road");
