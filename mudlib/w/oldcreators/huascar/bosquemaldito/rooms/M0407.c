...
add_exit("noroeste",CHA"M0506.c","road");
add_exit("norte",CHA"M0507.c","road");
add_exit("noreste",CHA"M0508.c","road");
add_exit("este",CHA"M0408.c","road");
add_exit("sudeste",CHA"M0308.c","road");
add_exit("sur",CHA"M0307.c","road");
add_exit("sudoeste",CHA"M0306.c","road");
add_exit("oeste",CHA"M0406.c","road");
}