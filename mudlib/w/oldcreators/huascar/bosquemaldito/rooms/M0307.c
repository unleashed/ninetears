...
add_exit("oeste",CHA"M0306.c","road");
add_exit("noroeste",CHA"M0406.c","road");
add_exit("norte",CHA"M0407.c","road");
add_exit("noreste",CHA"M0408.c","road");
add_exit("este",CHA"M0308.c","road");
add_exit("sudeste",CHA"M0208.c","road");
add_exit("sur",CHA"M0207.c","road");
add_exit("sudoeste",CHA"M0206.c","road");
}