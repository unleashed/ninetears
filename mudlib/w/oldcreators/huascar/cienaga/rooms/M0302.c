...
add_exit("noroeste",MAR"M0401.c","road");
add_exit("noreste",MAR"M0403.c","road");
add_exit("sur",MAR"M0202.c","road");
add_exit("sudoeste",MAR"M0201.c","road");
add_exit("este",MAR"M0303.c","road");
}