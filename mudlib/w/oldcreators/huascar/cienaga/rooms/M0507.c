...
add_exit("norte",MAR"M0607.c","road");
add_exit("noreste",MAR"M0608.c","road");
add_exit("sudeste",MAR"M0408.c","road");
add_exit("sudoeste",MAR"M0406.c","road");
add_exit("oeste",MAR"M0506.c","road");
}