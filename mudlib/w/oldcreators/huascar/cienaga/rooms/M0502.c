...
add_exit("noreste",MAR"M0601.c","road");
add_exit("norte",MAR"M0602.c","road");
add_exit("este",MAR"M0503.c","road");
add_exit("sudeste",MAR"M0403.c","road");
add_exit("sudoeste",MAR"M0401.c","road");
}