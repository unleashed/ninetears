...
add_exit("norte",MAR"M0506.c","road");
add_exit("oeste",MAR"M0405.c","road");
add_exit("noreste",MAR"M0507.c","road");
add_exit("sudeste",MAR"M0307.c","road");
add_exit("sur",MAR"M0306.c","road");
}