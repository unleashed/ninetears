...
add_exit("noroeste",MAR"M0502.c","road");
add_exit("sudoeste",MAR"M0302.c","road");
add_exit("este",MAR"M0404.c","road");
add_exit("norte",MAR"M0503.c","road");
add_exit("sur",MAR"M0303.c","road");
}