...
void setup()
{
set_short("%^WHITE%^Mausoleo%^RESET%^");
set_long("%^WHITE%^Mausoleo%^RESET%^\n\n Ante ti se encuentra el mausoleo resultado de la "
...
set_light(70);
set_zone("cienaga");
add_clone(NPC"guarda2.c",random(3)-1);
add_exit("norte",MAR"M1009.c","road");
add_exit("oeste",MAR"M0910.c","road");
add_exit("sur",MAR"M0809.c","road");
}
