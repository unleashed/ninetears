...
// Basado en Rabia , rabia 2 , rabia 3 y rabia enfocado por Yvendur Dec 99

#define FURIA_SHADOW "/d/gremios/comandos/shadows/furia_sh.c"
   	...
   	switch(COUNT) {
		...
		TIME = me->query_gp();
   		...
   		me->add_property("exhausto_furia",1);
        	...
        	me->adjust_tmp_ac_bon(-ACBONUS);
        	me->add_timed_property("furioso",4,100);
