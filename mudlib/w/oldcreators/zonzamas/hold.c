...
status hold_ob(object ob) 
{
	...
	{
	    tell_object(this_object(),"Careces de la habilidad necesaria para empunyar esta arma.\n");
	    return 1;
	}
    }
    if(ob->query_armour())
    ...
    */
    ...
    {
	notify_fail("No tienes suficientes manos disponibles para empunyar esto.\n");
	return 0;
    }
