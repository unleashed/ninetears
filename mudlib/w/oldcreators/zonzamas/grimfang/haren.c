...
void setup()
{
  set_short("%^BOLD%^Aposentos de %^GREEN%^Grimfang%^WHITE%^: Haren");
  set_long("\n%^BOLD%^Aposentos de %^GREEN%^Grimfang%^WHITE%^: Haren\n\n"
	   ...
	   " y ... sabores! Muchachitas rubias de ojos azulas y blanca piel, mulatitas de pelo negro "
