...
void setup() 
{
   ...
   set_light(20);
   set_short("%^BOLD%^YELLOW%^Minas de Keeroon: %^BOLD%^%^RED%^Nivel 2%^RESET%^");
   set_long("\n%^BOLD%^YELLOW%^Minas de Keeroon: %^BOLD%^%^RED%^Nivel 2%^RESET%^.\n\n"
...
//Salidas disponibles
add_exit("sur",MINAS2+"minas2_09.c","standard");
