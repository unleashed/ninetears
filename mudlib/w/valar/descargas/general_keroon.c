...
void setup()
{
  set_name("general de keroon");
  add_alias("guardia");
  add_alias("guardian");
  add_alias("capitan");
  set_short("general de keroon");
  ...
  set_cha(100);
set_level(42+random(5));/*ponedlo depues de los stats..pa ke rule bien si no calcula la vida antes del nivel y puede salir con muy poca.*/

   set_ciudadania("Keroon");

  set_main_plural("generales");
