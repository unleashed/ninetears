/* Archivo base a partir del que se generan las descripciones del camino norte de Noella */
...
/* DESCRIPCIONES DEL CAMINO NORTE */
...
string *descripciones1 = ({
 ...
 string *descripciones2 = ({
      "Dicha vegetación amenaza cada día más con engullirlo, por mucho que las gentes de "
         "Noella, al sur del camino, se empeñen en limpiarlo amenudo",
