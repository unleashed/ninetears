...
add_exit("norte", CALLEJONES+"callejon_G1","road");
add_exit("noreste", MERCADO+"mercado14","road");
add_exit("sudeste", CALLEJONES+"callejon_A4","road");
add_exit("sudoeste", CALLEJONES+"callejon_C3","road");
add_exit("dentro", PRINCIPALES+"lele1","road");
set_zone("noella");
