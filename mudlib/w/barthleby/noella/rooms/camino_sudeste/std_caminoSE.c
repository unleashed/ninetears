/* Archivo base a partir del que se generan las descripciones del camino sudeste de Noella */
...
/* DESCRIPCIONES DEL CAMINO SUDESTE */
...
string *descripciones1 = ({
      ...
      "Te encuentras en el acceso del norte a la ciudad de Noella. Puedes oír el chasquido "
 ...
 string *descripciones2 = ({
      "Dicha vegetación amenaza cada día más con engullirlo, por mucho que las gentes de "
         "Noella, al noroeste del camino, se empeñen en limpiarlo amenudo",
