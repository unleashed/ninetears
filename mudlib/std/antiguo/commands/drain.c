...
int hb_spell(object caster, mixed *params, int time)
{
  ...
  tell_object(caster, "Llevas tus manos sobre "+
    ...
    "y grita doloridamente cuando Tyrael le despoja de parte de su vida.\n");
  tell_object(params[0], caster->query_cap_name()+" acerca sus oscuras "
    "a ti, y comienza a sentirse refrescado.\n\n"
    "Te retuerces y gritas de dolor, sintiendo tu fuerza vital\narrancada"
