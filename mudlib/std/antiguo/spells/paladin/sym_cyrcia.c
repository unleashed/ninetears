...
/****** BUGS GRANDIOSOS: Si ya estas en peleas con alguien, la tia
	como si nada. Si pones mas de una, las demas sudan.
	Si tienes el consent follow off no te siguen XD */

#define BASE_THACO 150
#define HP_PER_LEVELX 5
#define ROUNDS_PER_LEVELX 20
#define CYRCIA_SYMBOL "/std/spells/items/medallon_aranya.c"
...
void setup()
{
  set_name("Aranya Roja Gigante");
  add_alias({"aranya gigante", "aranya"});
	set_main_plural("Aranyas Rojas Gigantes");
	add_plural("aranyas");
...
{
  ::init();
	add_attack_spell(20, "estallido de fuego", ({"/std/spells/paladin/estallido_fuego.c",
		"cast_spell", 1, 0}));
