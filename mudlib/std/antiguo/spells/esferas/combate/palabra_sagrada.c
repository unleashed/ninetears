...
void setup()
{
  ...
  set_target_type("all");
  set_range(0);
  set_help_desc("This spell channels part of the force of the caster's god through\n"
...
int round1(object caster, mixed target, mixed out_range, int time, int quiet)
{
  ...
  if (!quiet)
  {
    tell_object(caster,"You clutch your holy symbol tightly, and take a deep breath.\n"
