...
private string *todo;
private mapping global_aliases;

private string index_root;    /* "Root directory" */
private string *mergedirs;    /* Dirs under root to be merged */
private string save_file;     /* For save_object() */
private int no_file_security; /* All docs will be readable by all */
private string g_alias_file;  /* Holds global aliases */

private void sort_manual_dirs();
private mapping get_doc_dir(string dirname);
private varargs void create(int recreate);
